...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/sql/reference/dml/update/>).
...
UPDATE statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/interfaces/sql-client/>).
