...
The [Flink Operations Playground](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/try-flink/flink-operations-playground/>) includes a section on [Observing Failure & Recovery](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/try-flink/flink-operations-playground/#observing-failure--recovery>).

__Back to top

##  Further Reading #

  * [Stateful Stream Processing](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/concepts/stateful-stream-processing/>)
  * [State Backends](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/state_backends/>)
  * [Fault Tolerance Guarantees of Data Sources and Sinks](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/datastream/guarantees/>)
  * [Enabling and Configuring Checkpointing](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/datastream/fault-tolerance/checkpointing/>)
  * [Checkpoints](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/checkpoints/>)
  * [Savepoints](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/savepoints/>)
  * [Tuning Checkpoints and Large State](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/large_state_tuning/>)
  * [Monitoring Checkpointing](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/monitoring/checkpoint_monitoring/>)
  * [Task Failure Recovery](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/task_failure_recovery/>)
