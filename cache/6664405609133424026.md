...
EXPLAIN statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sqlclient/>).
...
Specify `CHANGELOG_MODE` will inform the optimizer to attach the changelog mode (see more details at [Dynamic Tables](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/concepts/dynamic_tables/#table-to-stream-conversion>)) of each physical rel node to the ouptput.
...
Flink SQL provides the plan advice targeting the following issues
  ...
  * Data Skewness caused by Group Aggregation (see more details at [Group Aggregation](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql/queries/group-agg/#group-aggregation>) and [Performance Tuning](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/tuning/#local-global-aggregation>))
  * Non-deterministic Updates (_abbr._ NDU, see more details at [Determinism In Continuous Queries](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/concepts/determinism/#3-determinism-in-streaming-processing>))
...
For query syntax, please refer to [Queries](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql/queries/overview/>) page. For insert syntax, please refer to [INSERT](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql/insert/>) page.