...
ALTER 语句用于修改一个已经在 [Catalog](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/catalogs/>) 中注册的表、视图或函数定义，或 catalog 本身的定义。
...
可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 中执行 ALTER 语句。
...
使用 `ADD` 语句向已有表中增加 [columns](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#columns>)，[constraints](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#primary-key>)，[watermark](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#watermark>)，[partitions](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#partitioned-by>) 和 [distribution](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#distributed>)。
...
See a dedicated page for [Materialized tables](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/materialized-table/statements/#alter-materialized-table>).
...
如果 language tag 是 JAVA 或者 SCALA ，则 identifier 是 UDF 实现类的全限定名。关于 JAVA/SCALA UDF 的实现，请参考 [自定义函数](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/dev/table/functions/udfs/>)。

如果 language tag 是 PYTHON ， 则 identifier 是 UDF 对象的全限定名，例如 `pyflink.table.tests.test_udf.add`。关于 PYTHON UDF 的实现，请参考 [Python UDFs](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/dev/table/functions/python-udfs/>)。
