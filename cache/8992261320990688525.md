...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/sql/reference/utility/explain/>).
...
EXPLAIN 语句可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/interfaces/sql-client/>) 中执行。
...
指定 `CHANGELOG_MODE` 将使得优化器（optimizer）将 changelog mode 附加在每个物理节点上输出。 关于 changelog mode 更多信息请参阅 [动态表](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/concepts/sql-table-concepts/dynamic_tables/#table-to-stream-conversion>)。
...
`PLAN_ADVICE` 提供针对如下问题的建议
  ...
  * 分组聚合（Group Aggregation）时产生的数据倾斜（更多信息请参阅 [分组聚合](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/queries/group-agg/#group-aggregation>) 和 [性能调优](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/table/tuning/#local-global-aggregation>)）
  * 非确定性更新（ _abbr._ NDU，更多信息请参阅 [流上的确定性](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/concepts/sql-table-concepts/determinism/#3-determinism-in-streaming-processing>)）
...
关于 query 的语法，请查阅 [Queries](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/queries/#supported-syntax>) 页面。 关于 INSERT 的语法，请查阅 [INSERT](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/dml/insert/>) 页面。