...
## First Steps
  ...
  * **Concepts** : Start with the [basic concepts](<//ci.apache.org/projects/flink/flink-docs-release-1.1/concepts/concepts.html>) of Flink. This will help you to fully understand the other parts of the documentation, including the setup and programming guides. It is highly recommended to read this first.
  ...
  * **Setup:** The [local](<//ci.apache.org/projects/flink/flink-docs-release-1.1/setup/local_setup.html>), [cluster](<setup/cluster_setup.html>), and [cloud](<setup/gce_setup.html>) setup guides show you how to deploy Flink.
