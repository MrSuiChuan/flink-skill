...
Note that Scala BigInt is not supported yet.
  ...
  17. ####  val LOCAL_DATE: TypeInformation[LocalDate]

[ ](<../../../../../../index.html#org.apache.flink.api.scala.typeutils.Types$@LOCAL_DATE:org.apache.flink.api.common.typeinfo.TypeInformation\[java.time.LocalDate\]> "Permalink")

Returns type information for java.time.LocalDate.

Returns type information for java.time.LocalDate. Supports a null value.

  18. ####  val LOCAL_DATE_TIME: TypeInformation[LocalDateTime]

[ ](<../../../../../../index.html#org.apache.flink.api.scala.typeutils.Types$@LOCAL_DATE_TIME:org.apache.flink.api.common.typeinfo.TypeInformation\[java.time.LocalDateTime\]> "Permalink")

Returns type information for java.time.LocalDateTime.

Returns type information for java.time.LocalDateTime. Supports a null value.

  19. ####  val LOCAL_TIME: TypeInformation[LocalTime]

[ ](<../../../../../../index.html#org.apache.flink.api.scala.typeutils.Types$@LOCAL_TIME:org.apache.flink.api.common.typeinfo.TypeInformation\[java.time.LocalTime\]> "Permalink")

Returns type information for java.time.LocalTime.

Returns type information for java.time.LocalTime. Supports a null value.

  20. ####  val LONG: TypeInformation[Long]
...
Returns type information for primitive Long and java.lang.Long. Does not support a null value.
  ...
  21. ####  val NOTHING: TypeInformation[Nothing]
...
Returns type information for Scala Nothing. Does not support a null value.
  ...
  22. ####  def OBJECT_ARRAY[E <: AnyRef](elementType: TypeInformation[E]): TypeInformation[Array[E]]
...
element type of the array
  ...
  23. ####  def OPTION[A, T <: Option[A]](valueType: TypeInformation[A]): TypeInformation[T]
...
type information of the option's value
  ...
  24. ####  def POJO[T](pojoClass: Class[T], fields: Map[String, TypeInformation[_]]): TypeInformation[T]
...
map of fields that map a name to type information. The map key is the name of the field and the value is its type.
  ...
  25. ####  def POJO[T](pojoClass: Class[T]): TypeInformation[T]
...
POJO class to be analyzed by Flink
  ...
  26. ####  def PRIMITIVE_ARRAY(elementType: TypeInformation[_]): TypeInformation[_]
...
element type of the array (e.g. Types.BOOLEAN, Types.INT, Types.DOUBLE)
  ...
  27. ####  def ROW(fieldNames: Array[String], types: Array[TypeInformation[_]]): TypeInformation[Row]
...
array of field types
  ...
  28. ####  def ROW(types: TypeInformation[_]*): TypeInformation[Row]
...
The types of the row fields, e.g., Types.STRING, Types.INT
  ...
  29. ####  val SHORT: TypeInformation[Short]
...
Returns type information for primitive Short and java.lang.Short. Does not support a null value.
  ...
  30. ####  val SQL_DATE: TypeInformation[Date]
...
Returns type information for java.sql.Date. Supports a null value.
  ...
  31. ####  val SQL_TIME: TypeInformation[Time]
...
Returns type information for java.sql.Time. Supports a null value.
  ...
  32. ####  val SQL_TIMESTAMP: TypeInformation[Timestamp]
...
Returns type information for java.sql.Timestamp. Supports a null value.
  ...
  33. ####  val STRING: TypeInformation[String]
...
Returns type information for String and java.lang.String. Supports a null value.
  ...
  34. ####  def TRAVERSABLE[T](implicit arg0: TypeInformation[T]): TypeInformation[T]
...
Returns type information for Scala collections that implement Traversable. Null values are not supported.
  ...
  35. ####  def TRY[A, T <: Try[A]](valueType: TypeInformation[A]): TypeInformation[T]
...
type information of the try's value
  ...
  36. ####  def TUPLE[T](implicit arg0: TypeInformation[T]): TypeInformation[T]
...
tuple to be analyzed
  ...
  37. ####  val UNIT: TypeInformation[Unit]
...
Definition Classes
  ...
  49. ####  def of[T](implicit arg0: TypeInformation[T]): TypeInformation[T]
