...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/testing/>).
...
To use the test harnesses a set of additional dependencies is needed. Refer to the [configuration](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/configuration/testing/>) section for more detail.
...
A few remarks on integration testing with `MiniClusterWithClientResource`:
  ...
  * You can implement a custom _parallel_ source function for emitting watermarks if your job uses event time timers.
