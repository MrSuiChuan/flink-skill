...
You can refer [overview](<//nightlies.apache.org/flink/flink-cdc-docs-master/docs/connectors/pipeline-connectors/overview/>) to check supported versions and download [the binary release](<https://flink.apache.org/downloads/>) of Flink, then extract the archive:
