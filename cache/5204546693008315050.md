...
The connector can operate in upsert mode for exchanging UPSERT/DELETE messages with the external system using a [key defined by the query](<./streaming/dynamic_tables.html#table-to-stream-conversion>).
