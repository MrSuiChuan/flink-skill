...
Steps to run a secure Flink cluster in standalone/cluster mode:
  ...
  1. Add security-related configuration options to the Flink configuration file (on all cluster nodes) (see [here](<//nightlies.apache.org/flink/flink-docs-release-1.13/docs/deployment/config/#auth-with-external-systems>)).
...
Steps to run a secure Flink cluster in native Kubernetes, YARN and Mesos mode:
  ...
  1. Add security-related configuration options to the Flink configuration file on the client (see [here](<//nightlies.apache.org/flink/flink-docs-release-1.13/docs/deployment/config/#auth-with-external-systems>)).
