...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/blackhole/>).
...
Alternatively, it may be based on an existing schema using the [LIKE Clause](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/reference/ddl/create/#create-table>).
