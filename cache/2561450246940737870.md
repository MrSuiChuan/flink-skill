...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/ops/monitoring/back_pressure/>).
...
在 Job Overview 旁的 _Back Pressure_ 选项卡中，你可以找到更多细节指标。
