...
Please see [operators](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/datastream/operators/overview/>) for an overview of the available DataStream transformations.
