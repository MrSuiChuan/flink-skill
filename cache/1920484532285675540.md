...
For information on how to set up Flink’s event reporters please take a look at the [event reporters documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/deployment/event_reporters/>).
