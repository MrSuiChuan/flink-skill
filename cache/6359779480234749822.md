...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/deployment/repls/scala_shell/>).
...
> The Scala REPL currently is currently only supported by the Scala 2.11 Flink distribution. Please follow [Jira](<https://issues.apache.org/jira/browse/FLINK-10911>) for the status of >= 2.12 support.
