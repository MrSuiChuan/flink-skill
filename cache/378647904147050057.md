...
To do this, the fraud detector must _remember_ information across events; a large transaction is only fraudulent if the previous one was small. Remembering information across events requires [state](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/concepts/glossary/#managed-state>), and that is why this tutorial uses a [KeyedProcessFunction](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/process_function/>). It provides fine-grained control over both state and time, which will allow you to evolve the algorithm with more complex requirements.
...
The command builds and runs your PyFlink program in a local mini cluster. You can also submit the Python DataStream program to a remote cluster. Refer to [Job Submission Examples](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/deployment/cli/#submitting-pyflink-jobs>) for more details.
...
To learn how to add timers to your fraud detector (e.g., only flag transactions occurring within 1 minute of each other), see the [Event-Driven Applications](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/learn-flink/event_driven/>) section in Learn Flink.

###  Learn More About DataStream #

  * [DataStream API Overview](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/overview/>): Complete DataStream API reference
  * [Process Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/process_function/>): Deep dive into KeyedProcessFunction and other process functions
  * [State & Fault Tolerance](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/fault-tolerance/state/>): Understanding managed state and checkpointing

###  Explore Other Tutorials #

  * [Flink SQL Tutorial](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/quickstart-sql/>): Interactive SQL queries without coding
  * [Table API Tutorial](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/table_api/>): Build streaming pipelines with the Table API
  * [Flink Operations Playground](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/flink-operations-playground/>): Learn to operate Flink clusters

###  Production Deployment #

  * [Deployment Overview](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/deployment/overview/>): Deploy Flink in production
  * [Connectors](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/datastream/overview/>): Connect to Kafka, databases, filesystems, and more