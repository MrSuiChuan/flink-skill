#  [Applying to Google Season of Docs 2020](</2020/05/04/applying-to-google-season-of-docs-2020/>)

May 4, 2020 - Marta Paes [(@morsapaes)](<https://twitter.com/morsapaes>)
...
Please [subscribe](<mailto:dev-subscribe@flink.apache.org>) to the Apache Flink mailing list before reaching out. If you are not subscribed then responses to your message will not go through. You can always [unsubscribe](<mailto:dev-unsubscribe@flink.apache.org>) at any time.
...
###  Related Resources #
  ...
  * Table API & SQL Documentation: [//nightlies.apache.org/flink/flink-docs-release-1.10/dev/table/](<//nightlies.apache.org/flink/flink-docs-release-1.10/dev/table/>)
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2020-05-04-season-of-docs.md>)