...
你可以通过 [此链接](<https://join.slack.com/t/apache-flink/shared_invite/zt-3czkam2ts-34ztV8gAD9CpLe47BcyUog>) 加入 Apache Flink 社区专属的 Slack 工作空间。 在成功加入后，不要忘记在 #introductions 频道介绍你自己。 Slack 规定每个邀请链接最多可邀请 100 人，如果遇到上述链接失效的情况，请联系 [Dev 邮件列表](</zh/what-is-flink/community/#mailing-lists>)。 所有已经加入社区 Slack 空间的成员同样可以邀请新成员加入。
...
如果你发现一个意外行为可能是由 Bug 导致的，你可以在 [Flink’s JIRA](</zh/what-is-flink/community/#issue-%e8%bf%bd%e8%b8%aa>) 中搜索已经上报的 Bug 或者发布该 Bug。

如果你不确定意外行为的发生是否由 Bug 引起的，请发送问题到 [用户邮件列表](</zh/what-is-flink/community/#user-mailing-list>)。
...
请参阅 [类型提取和序列化](<//nightlies.apache.org/flink//dev/types_serialization.html>) 深入讨论 Flink 如何处理类型。
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content.zh/how-to-contribute/getting-help.md>)