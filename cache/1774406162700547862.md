...
Flink comes with an integrated interactive Python Shell. It can be used in a local setup as well as in a cluster setup. See the [standalone resource provider page](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/resource-providers/standalone/overview/>) for more information about how to setup a local Flink. You can also [build a local setup from source](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/flinkdev/building/>).

Note The Python Shell will run the command “python”. Please refer to the Python Table API [installation guide](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/python/installation/>) on how to set up the Python execution environments.
