...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-connector-jdbc_2.11/1.14.4/flink-connector-jdbc_2.11-1.14.4.jar>)
---|---
...
JDBC connector and drivers are not currently part of Flink’s binary distribution. See how to link with them for cluster execution [here](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/datastream/project-configuration/>).
...
MySQL type[](<https://dev.mysql.com/doc/man/8.0/en/data-types.html>) | PostgreSQL type[](<https://www.postgresql.org/docs/12/datatype.html>) | Flink SQL type[](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/types/>)
---|---|---
`TINYINT` |  | `TINYINT`
`SMALLINT`
