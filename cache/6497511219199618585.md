...
Tables can be created from [external systems](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/table/overview/>) (Kafka, files, databases), from DataStreams, or inline using values.
...
For a complete list of built-in functions, see the [Built-in Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/systemfunctions/>) reference.
...
For more on windows, see the [Group Aggregation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/tableapi/#group-windows>) documentation.
...
For more details on UDFs, see the [User-defined Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/udfs/>) documentation.
...
For the complete PTF guide, see [Process Table Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/ptfs/>).

__Back to top

##  Hands-on #

At this point you know enough to get started coding and running a simple Table API application. Clone the [ flink-training-repo ](<//github.com/apache/flink-training/tree/release-2.3/>) , and after following the instructions in the README, try the Table API exercises.

__Back to top

##  Further Reading #

  * [Table API Operations](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/tableapi/>) \- Complete reference for all operations
  * [Built-in Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/systemfunctions/>) \- All available functions
  * [User-Defined Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/udfs/>) \- Creating custom functions
  * [Process Table Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/ptfs/>) \- Advanced stateful processing
  * [SQL & Table API Connectors](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/table/overview/>) \- Reading from and writing to external systems
  * [Common Concepts](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/common/>) \- Shared concepts between Table API and SQL
