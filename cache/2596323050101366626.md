...
---|---|---
2.3.0 - 2.3.10 | `flink-sql-connector-hive-2.3.10` | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-connector-hive-2.3.10_2.12/2.0.1/flink-sql-connector-hive-2.3.10_2.12-2.0.1.jar>)
3.0.0 - 3.1.3 | `flink-sql-connector-hive-3.1.3` | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-connector-hive-3.1.3_2.12/2.0.1/flink-sql-connector-hive-3.1.3_2.12-2.0.1.jar>)
...
Hive 2.3.4
    ...
    /flink-2.0.1
       /lib
           ...
           flink-connector-hive-2.0.1.jar
...
Connect to an existing Hive installation using the [catalog interface](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/catalogs/>) and [HiveCatalog](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/table/hive/hive_catalog/>) through the table environment or YAML configuration.
...
It’s recommended to use [Hive dialect](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/hive-compatibility/hive-dialect/overview/>) to execute DDLs to create Hive tables, views, partitions, functions within Flink.

##  DML #

Flink supports DML writing to Hive tables. Please refer to details in [Reading & Writing Hive Tables](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/table/hive/hive_read_write/>)