...
日志文件可以通过 Job-/TaskManager 对应的 WebUI 页面访问。所使用的 [Resource Provider](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/deployment/overview/>)（如 YARN）可能会提供额外的访问方式来访问日志。
