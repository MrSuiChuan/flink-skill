...
This page covers how to build Flink 1.15.4 from sources.
...
_NOTE: Maven 3.3.x can build Flink, but will not properly shade away certain dependencies. Maven 3.2.5 creates the libraries properly._
