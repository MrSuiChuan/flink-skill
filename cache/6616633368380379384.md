...
The following example uses the example schema [ testdata.avsc ](<//github.com/apache/flink/blob/release-1.16/flink-formats/flink-parquet/src/test/resources/avro/testdata.avsc>) :
...
This example uses a simple Java POJO class [ Datum ](<//github.com/apache/flink/blob/release-1.16/flink-formats/flink-parquet/src/test/java/org/apache/flink/formats/parquet/avro/Datum.java>) :
