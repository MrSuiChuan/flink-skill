...
| optional | yes | false | Boolean | Optional flag to trim leading/trailing spaces from unquoted field values (disabled by default). Only affects deserialization.

##### csv.ignore-trailing-unmappable

| optional | yes | false | Boolean | Optional flag to ignore extra trailing fields that cannot be mapped to the schema (disabled by default). Only affects deserialization.

##### csv.allow-trailing-comma

| optional | yes | true | Boolean | Optional flag to allow a trailing comma after the last field value (enabled by default). Only affects deserialization.

##### csv.fail-on-missing-columns

| optional | yes | false | Boolean | Optional flag to fail when a row has fewer columns than the schema expects (disabled by default). Only affects deserialization.

##### csv.empty-string-as-null

| optional | yes | false | Boolean | Optional flag to treat empty string values as null (disabled by default). Only affects deserialization.
