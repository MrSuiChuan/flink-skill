...
If you want to implement your own _custom_ table source or sink, have a look at the [user-defined sources & sinks page](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sourcessinks/>).
...
---|---|---|---
[Filesystem](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/filesystem/>) |  | Bounded and Unbounded Scan, Lookup | Streaming Sink, Batch Sink
[Elasticsearch](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/elasticsearch/>) | 6.x & 7.x | Not supported | Streaming Sink, Batch Sink
[Apache Kafka](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/kafka/>) | 0.10+ | Unbounded Scan | Streaming Sink, Batch Sink
[Amazon DynamoDB](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/dynamodb/>) |  | Not supported | Streaming Sink, Batch Sink
[Amazon Kinesis Data Streams](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/kinesis/>) |  | Unbounded Scan | Streaming Sink
[Amazon Kinesis Data Firehose](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/firehose/>) |  | Not supported | Streaming Sink
[JDBC](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/jdbc/>) |  | Bounded Scan, Lookup | Streaming Sink, Batch Sink
[Apache HBase](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/hbase/>) | 1.4.x & 2.2.x | Bounded Scan, Lookup | Streaming Sink, Batch Sink
[Apache Hive](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/hive/overview/>) | [Supported Versions](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/table/hive/overview/#supported-hive-versions>) | Unbounded Scan, Bounded Scan, Lookup | Streaming Sink, Batch Sink

__Back to top

Please refer to the [configuration](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/configuration/connector/>) section on how to add connectors as a dependency.
...
See the [SQL section for more information about creating a table](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/create/#create-table>).
...
Some connectors and formats expose additional metadata fields that can be accessed in metadata columns next to the physical payload columns. See the [`CREATE TABLE` section](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/create/#columns>) for more information about metadata columns.
...
For more information about time handling in Flink and especially event-time, we recommend the general [event-time section](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/concepts/time_attributes/>).

####  Proctime Attributes #

In order to declare a proctime attribute in the schema, you can use [Computed Column syntax](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/create/#create-table>) to declare a computed column which is generated from `PROCTIME()` builtin function. The computed column is a virtual column which is not stored in the physical data.
...
Please refer to [CREATE TABLE statements](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/create/#create-table>) for more information about defining time attributes in DDL.
...
Please see the [Data Types](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/types/>) page about how to declare a type in SQL.
