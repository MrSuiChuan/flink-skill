...
DROP statements are used to remove a catalog with the given catalog name or to remove a registered table/view/function from the current or specified [Catalog](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/catalogs/>).
...
DROP statements can be in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/sqlclient/>).
