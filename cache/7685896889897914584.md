...
**We encourage everyone to[download the release](<http://flink.apache.org/downloads.html>) and [check out the documentation](<//nightlies.apache.org/flink/flink-docs-release-1.1/>). Feedback through the Flink [mailing lists](<http://flink.apache.org/community.html#mailing-lists>) is, as always, very welcome!**

Some highlights of the release are listed in the following sections.

##  Connectors #

The [streaming connectors](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/connectors/index.html>) are a major part of Flink’s DataStream API. This release adds support for new external systems and further improves on the available connectors.
...
This will monitor `hdfs:///file-path` every `5000` milliseconds. Check out the [DataSource documentation for more details](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/index.html#data-sources>).
...
Check out the [Kinesis connector documentation for more details](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/connectors/kinesis.html>).
...
Check out the [Cassandra Sink documentation for more details](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/connectors/cassandra.html>).
...
A more detailed introduction can be found in the [Flink blog](<http://flink.apache.org/news/2016/05/24/stream-sql.html>) and the [Table API documentation](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/table.html>).
...
Session windows are ideal for cases where the window boundaries need to adjust to the incoming data. This enables you to have windows that start at individual points in time for each key and that end once there has been a _certain period of inactivity_. The configuration parameter is the session gap that specifies how long to wait for new data before considering a session as closed.
...
You can now specify how a windowed transformation should deal with late elements and how much lateness is allowed. The parameter for this is called _allowed lateness_. This specifies by how much time elements can be late.
...
Check out the [Windows documentation for more details](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/windows.html>).
...
A more detailed introduction can be found in the [Flink blog](<http://flink.apache.org/news/2016/04/06/cep-monitoring.html>) and the [CEP documentation](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/streaming/libs/cep.html>).
...
For a full list of new graph processing features, check out the [Gelly documentation](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/batch/libs/gelly.html>).
...
Check out the [Metrics documentation for more details](<//nightlies.apache.org/flink/flink-docs-release-1.1/apis/metrics.html>).
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2016-08-04-release-1.1.0.md>)