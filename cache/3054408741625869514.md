...
This document shows how to use lambda expressions and describes current limitations. For a general introduction to the Flink API, please refer to the [DataStream API overview](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/overview/>)
