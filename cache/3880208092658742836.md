...
Window join 作用在两个流中有相同 key 且处于相同窗口的元素上。这些窗口可以通过 [window assigner](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/dev/datastream/operators/windows/#window-assigners>) 定义，并且两个流中的元素都会被用于计算窗口的结果。
