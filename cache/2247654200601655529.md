...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/kinesis/>).
...
Version | PyFlink JAR | flink-connector-aws-kinesis-streams | Only available for stable releases.
---|---
See [Python dependency management](<//nightlies.apache.org/flink/flink-docs-master//docs/dev/python/dependency_management/#jar-dependencies>) for more details on how to use JARs in PyFlink.
...
> The old Kinesis source `org.apache.flink.streaming.connectors.kinesis.FlinkKinesisConsumer` is deprecated and may be removed with a future release of Flink, please use [Kinesis Source](<//nightlies.apache.org/flink/flink-docs-master/docs/connectors/datastream/kinesis/#kinesis-streams-source>) instead.
...
The Kinesis Sink provides some metrics through Flink’s [metrics system](<//nightlies.apache.org/flink/flink-docs-master/docs/ops/metrics/>) to analyze the behavior of the connector. A list of all exposed metrics may be found [here](<//nightlies.apache.org/flink/flink-docs-master/docs/ops/metrics/#kinesis-sink>).
...
> The old Kinesis sink `org.apache.flink.streaming.connectors.kinesis.FlinkKinesisProducer` is deprecated and may be removed with a future release of Flink, please use [Kinesis Sink](<//nightlies.apache.org/flink/flink-docs-master/docs/connectors/datastream/kinesis/#kinesis-streams-sink>) instead.
