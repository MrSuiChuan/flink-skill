...
The `DataStream#split()` operation has been removed after being marked as deprecated for a couple of versions. Please use [Side Outputs](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/datastream/side_output/>)) instead.
...
Please refer to the [documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/connectors/datastream/kafka/>) to learn about how to upgrade the Flink Kafka Connector version.
...
The SQL Client jar was renamed to flink-sql-avro-1.19.3.jar, previously flink-avro-1.19.3-sql-jar.jar. Moreover it is no longer needed to add Avro dependencies manually.
