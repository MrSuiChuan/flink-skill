...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/dataset/transformations/>).
...
This document gives a deep-dive into the available transformations on DataSets. For a general introduction to the Flink Java API, please refer to the [Programming Guide](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/dev/dataset/overview/>).

For zipping elements in a data set with a dense index, please refer to the [Zip Elements Guide](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/dev/dataset/zip_elements_guide/>).
...
Work analogous to key expressions, key-selector functions, and case class fields in _Reduce_ transformations.
