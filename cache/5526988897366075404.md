...
All [file systems](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/filesystems/overview/>) are pluggable. That means they can and should be used as plugins. To use a pluggable file system, copy the corresponding JAR file from the `opt` directory to a directory under `plugins` directory of your Flink distribution before starting Flink, e.g.


    mkdir ./plugins/s3-fs-hadoop
    cp ./opt/flink-s3-fs-hadoop-1.16.2.jar ./plugins/s3-fs-hadoop/
...
All [metric reporters](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/metric_reporters/>) that Flink provides can be used as plugins. See the [metrics](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/ops/metrics/>) documentation for more details.
