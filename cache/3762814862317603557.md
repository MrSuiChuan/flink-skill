...
If you want to use event time, you will also need to supply a Timestamp Extractor and Watermark Generator that Flink will use to track the progress of event time. This will be covered in the section below on [Working with Watermarks](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/learn-flink/streaming_analytics/#working-with-watermarks>), but first we should explain what watermarks are.
...
You can arrange for the events that would be dropped to be collected to an alternate output stream instead, using a mechanism called [Side Outputs](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/learn-flink/event_driven/#side-outputs>). Here is an example of what that might look like:
...
Note, however, that the tumbling and sliding window assigners take an optional offset parameter that can be used to change the alignment of the windows. See [Tumbling Windows](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/windows/#tumbling-windows>) and [Sliding Windows](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/windows/#sliding-windows>) for details.
...
The hands-on exercise that goes with this section is the [ Hourly Tips Exercise ](<//github.com/apache/flink-training/blob/release-2.3//hourly-tips>) .

##  Further Reading #

  * [Timely Stream Processing](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/concepts/time/>)
  * [Windows](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/windows/>)
