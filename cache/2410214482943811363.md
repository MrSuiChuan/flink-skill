...
Currently, the Maxwell format uses JSON for serialization and deserialization. Please refer to [JSON Format documentation](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/connectors/table/formats/json/#data-type-mapping>) for more details about the data type mapping.