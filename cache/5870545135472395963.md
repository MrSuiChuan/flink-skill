...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/analyze/>).
...
`ANALYZE TABLE` statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/dev/table/sqlclient/>).
