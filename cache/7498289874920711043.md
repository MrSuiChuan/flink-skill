...
The MongoDB connector is not part of the binary distribution. See how to link with it for cluster execution [here](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/configuration/overview/>).
...
See [CREATE TABLE DDL](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/#create-table>) for more details about PRIMARY KEY syntax.
...
[MongoDB BSON type](<https://www.mongodb.com/docs/manual/reference/bson-types/#bson-types>) | [Flink SQL type](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/types/>)
---|---
`ObjectId` | `STRING`
`String` | `STRING`
`Boolean` | `BOOLEAN`
