...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/release-notes/flink-1.12/>).
...
The `DataStream#split()` operation has been removed after being marked as deprecated for a couple of versions. Please use [Side Outputs](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/datastream/side_output/>)) instead.
...
Please refer to the [documentation](<//nightlies.apache.org/flink/flink-docs-master/docs/connectors/datastream/kafka/>) to learn about how to upgrade the Flink Kafka Connector version.
...
The SQL Client jar was renamed to flink-sql-avro-2.4-SNAPSHOT.jar, previously flink-avro-2.4-SNAPSHOT-sql-jar.jar. Moreover it is no longer needed to add Avro dependencies manually.
