...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/formats/raw/>).
...
**Note:** When the same delimiter is configured for both serialization and deserialization, the two are round-trip compatible: a trailing delimiter appended by the serializer is automatically stripped during deserialization.
