...
`SELECT` statements and `VALUES` statements are specified with the `sqlQuery()` method of the `TableEnvironment`. The method returns the result of the SELECT statement (or the VALUES statements) as a `Table`. A `Table` can be used in [subsequent SQL and Table API queries](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#mixing-table-api-and-sql>), be [converted into a DataStream](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#integration-with-datastream>), or [written to a TableSink](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#emit-a-table>). SQL and Table API queries can be seamlessly mixed and are holistically optimized and translated into a single program.

In order to access a table in a SQL query, it must be [registered in the TableEnvironment](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#register-tables-in-the-catalog>). A table can be registered from a [TableSource](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#register-a-tablesource>), [Table](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#register-a-table>), CREATE TABLE statement, [DataStream](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/common/#register-a-datastream>). Alternatively, users can also [register catalogs in a TableEnvironment](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/catalogs/>) to specify the location of the data sources.
...
`TableResult.collect()` and `TableResult.print()` have slightly different behaviors under different checkpointing settings (to enable checkpointing for a streaming job, see [checkpointing config](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/config/#checkpointing>)).
...
##  Operations #
  ...
  * [WITH clause](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/with/>)
  * [SELECT & WHERE](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/select/>)
  * [SELECT DISTINCT](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/select-distinct/>)
  * [Windowing TVF](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/window-tvf/>)
  * [Window Aggregation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/window-agg/>)
  * [Group Aggregation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/group-agg/>)
  * [Over Aggregation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/over-agg/>)
  * [Joins](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/joins/>)
  * [Set Operations](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/set-ops/>)
  * [ORDER BY clause](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/orderby/>)
  * [LIMIT clause](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/limit/>)
  * [Top-N](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/topn/>)
  * [Window Top-N](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/window-topn/>)
  * [Deduplication](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/deduplication/>)
  * [Pattern Recognition](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/match_recognize/>)
