...
The `HiveModule` provides Hive built-in functions as Flink’s system functions to SQL and Table API users. Flink’s [Hive documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/table/hive/hive_functions/>) provides full details on setting up the module.
