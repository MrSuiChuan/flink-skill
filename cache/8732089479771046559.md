#  [Apache Flink 1.5.0 Release Announcement](</2018/05/18/apache-flink-1.5.0-release-announcement/>)

May 18, 2018 - Fabian Hueske [(@fhueske)](<https://twitter.com/fhueske>)
...
We encourage everyone to [download the release](<http://flink.apache.org/downloads.html>) and check out the [documentation](<//nightlies.apache.org/flink/flink-docs-release-1.5/>). Feedback through the Flink [mailing lists](<http://flink.apache.org/community.html#mailing-lists>) or [JIRA](<https://issues.apache.org/jira/projects/FLINK/summary>) is, as always, very much appreciated!
...
Please review the [release notes](<//nightlies.apache.org/flink/flink-docs-release-1.5/release-notes/flink-1.5.html>) if you plan to upgrade your Flink setup to Flink 1.5.
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2018-05-18-release-1.5.0.md>)