#  [Apache Flink 0.8.0 available](</2015/01/21/apache-flink-0.8.0-available/>)
...
##  Overview of major new features #
  ...
  * **Extended filesystem support** : The former `DistributedFileSystem` interface has been generalized to `HadoopFileSystem` now supporting all sub classes of `org.apache.hadoop.fs.FileSystem`. This allows users to use all file systems supported by Hadoop with Apache Flink. [See connecting to other systems](<//nightlies.apache.org/flink/flink-docs-release-0.8/example_connectors.html>)
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2015-01-21-release-0.8.md>)