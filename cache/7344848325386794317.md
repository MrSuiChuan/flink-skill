...
See the [table state management section](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/concepts/sql-table-concepts/overview/#state-management>) for more information.
...
Before starting the migration, please check that the jobs you are trying to migrate are following the best practices for [savepoints](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/ops/state/savepoints/>).
...
For more details, please read the [savepoint documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/ops/state/savepoints/>).
...
If you are unfamiliar with installing Flink in your cluster, please read the [deployment and cluster setup documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/deployment/resource-providers/standalone/overview/>).
...
For more details, please take a look at the [savepoint documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/ops/state/savepoints/>).
