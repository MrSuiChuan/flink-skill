...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/modules/>).
...
The `HiveModule` provides Hive built-in functions as Flink’s system functions to SQL and Table API users. Flink’s [Hive documentation](<//nightlies.apache.org/flink/flink-docs-master/docs/connectors/table/hive/hive_functions/>) provides full details on setting up the module.
