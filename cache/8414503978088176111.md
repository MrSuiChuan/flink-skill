...
The JSON format supports append-only streams, unless you’re using a connector that explicitly support retract streams and/or upsert streams like the [Upsert Kafka](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/upsert-kafka/>) connector. If you need to write retract streams and/or upsert streams, we suggest you to look at CDC JSON formats like [Debezium JSON](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/formats/debezium/>) and [Canal JSON](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/formats/canal/>).
