...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream-v2/overview/>).
...
More details can be found in:
  ...
  * [Building Blocks](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/building_blocks/>): Given the most basic elements of DataStream API.
  * [State Processing](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/context_and_state_processing/>): Explanation of how to develop stateful applications.
  * [Time Processing # Processing Timer Service](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/time-processing/processing_timer_service/>): Explanation of how to handle processing time.
  * [Watermark](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/watermark/>): Explanation of how to define and handle user defined events.
...
More details can be found in:
  ...
  * [Time Processing # Event Timer Service](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/time-processing/event_timer_service/>): Explanation of how to handle event time via extension.
  * [Builtin Functions](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/builtin-funcs/windows/>): Explanation of how to do window aggregation and join via extension.
...
Sources are where your program reads its input from. You can attach a source to your program by using `ExecutionEnvironment.fromSource(source, sourceName)`. Flink comes with a number of pre-implemented source, you can use [FLIP-27](<https://cwiki.apache.org/confluence/x/co_zBQ>) based source via `DataStreamV2SourceUtils.wrapSource(source)` or use `DataStreamV2SourceUtils.fromData(collection)` for testing/debugging purpose.
...
Since data from source has no clear partitioning, this will give you a `NonKeyedPartitionStream` on which you can then apply transformations to create new derived DataStreams. For other types of DataStream, see [Building Blocks # DataStream](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/building_blocks/#datastream>).
...
This will create a new DataStream by converting every String in the original collection to an Integer. For more details of processing, see [Building Blocks # Process Function](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/building_blocks/#processfunction>).
...
##  Where to go next? #
  ...
  * [Building Blocks](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/building_blocks/>)
  * [Context and State Processing](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/context_and_state_processing/>)
  * [Time Processing](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/time-processing/processing_timer_service/>)
  * [Builtin Functions](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/builtin-funcs/windows/>)
  * [Watermark](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream-v2/watermark/>)
