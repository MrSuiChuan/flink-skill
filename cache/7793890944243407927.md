...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/sql/reference/queries/model-inference/>).

#  模型推理 #

Streaming

Flink SQL 提供了 `ML_PREDICT` 表值函数（TVF）来在 SQL 查询中执行模型推理。该函数允许您直接在 SQL 中对数据流应用机器学习模型。 请参阅[模型创建](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/ddl/create/#create-model>)了解如何创建模型。
...
###  相关语句 #
  ...
  * [模型创建](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/ddl/create/#create-model>)
  * [模型修改](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/reference/ddl/alter/#alter-model>)

###  支持的模型提供者 #

Flink 目前支持以下模型提供者：

  * **OpenAI** ：用于调用 OpenAI API 服务。详情请参见 [OpenAI 模型文档](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/connectors/models/openai/>)。
  * **Triton** ：用于调用 NVIDIA Triton 推理服务器。详情请参见 [Triton 模型文档](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/connectors/models/triton/>)。
