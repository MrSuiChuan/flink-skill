...
Users are advised to use the Pulsar connector with Java 8 or overprovision memory for Flink. Read the [memory setup guide](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/deployment/memory/mem_setup_tm/>) on how to configure memory for Flink and track the proper solution in [FLINK-24302](<https://issues.apache.org/jira/browse/FLINK-24302>).
