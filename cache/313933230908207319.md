...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/mongodb/>).
...
The MongoDB connector is not part of the binary distribution. See how to link with it for cluster execution [here](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/configuration/overview/>).
...
[MongoDB BSON type](<https://www.mongodb.com/docs/manual/reference/bson-types/#bson-types>) | [Flink SQL type](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/table/types/>)
---|---
`ObjectId` | `STRING`
`String` | `STRING`
`Boolean` | `BOOLEAN`
