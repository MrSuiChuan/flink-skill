...
Commonly used I/O components are bundled into the runtime by default and can be configured directly via the applications [module configuration](<//nightlies.apache.org/flink/flink-statefun-docs-release-3.2/docs/modules/overview/>). Additionally, custom connectors for other systems can be [plugged in](<//nightlies.apache.org/flink/flink-statefun-docs-release-3.2/docs/modules/io/flink-connectors/>) to the runtime.
