...
Emitting data to a side output is possible from the following functions:
  ...
  * [KeyedProcessFunction](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/operators/process_function/#the-keyedprocessfunction>)
  * CoProcessFunction
  * KeyedCoProcessFunction
  * [ProcessWindowFunction](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/operators/windows/#processwindowfunction>)
