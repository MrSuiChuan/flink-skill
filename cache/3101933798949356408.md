...
Gelly is a Graph API for Flink. It contains a set of methods and utilities which aim to simplify the development of graph analysis applications in Flink. In Gelly, graphs can be transformed and modified using high-level functions similar to the ones provided by the batch processing API. Gelly provides methods to create, transform and modify graphs, as well as a library of graph algorithms.
  ...
  * [Graph API](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/graph_api/>)
  * [Iterative Graph Processing](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/iterative_graph_processing/>)
  * [Library Methods](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/library_methods/>)
  * [Graph Algorithms](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/graph_algorithms/>)
  * [Graph Generators](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/graph_generators/>)
  * [Bipartite Graphs](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/bipartite_graph/>)
...
Note that Gelly is not part of the binary distribution. See [linking](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/configuration/overview/>) for instructions on packaging Gelly libraries into Flink user programs.
...
The size of the graph is adjusted by the _\--scale_ and _\--edge_factor_ parameters. The [library generator](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/libs/gelly/graph_generators/#rmat-graph>) provides access to additional configuration to adjust the power-law skew and random noise.
