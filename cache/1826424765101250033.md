...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-avro/1.14.4/flink-sql-avro-1.14.4.jar>)
---|---
...
| optional | (none) | String | For [Filesystem](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/connectors/table/filesystem/>) only, the compression codec for avro. No compression as default. The valid enumerations are: deflate, snappy, bzip2, xz.
