...
All available configuration options are listed on the [configuration page](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/config/>), in particular the [Basic Setup](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/config/#basic-setup>) section contains good advise on configuring the ports, memory, parallelism etc.
...
There’s a dedicated page on the [logging](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/advanced/logging/>) in Flink.
...
Note that the configuration key [jobmanager.rpc.address](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/config/#jobmanager-rpc-address>) needs to be set to `master1` for this to work.
...
In order to enable HA for a standalone cluster, you have to use the [ZooKeeper HA services](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/ha/zookeeper_ha/>).
...
By default, the JobManager will pick a _random port_ for inter process communication. You can change this via the [high-availability.jobmanager.port](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/config/#high-availability-jobmanager-port>) key. This key accepts single ports (e.g. `50010`), ranges (`50000-50025`), or a combination of both (`50010,50011,50020-50025,50050-50075`).
...
Please refer to the [Debugging Classloading Docs](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/ops/debugging/debugging_classloading/#overview-of-classloading-in-flink>) for details.
