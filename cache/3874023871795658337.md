...
or through the [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `--jarfile` when submitting the job.
...
You could also specify the Python libraries using configuration [`python.files`](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-files>) or via [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `-pyfs` or `--pyFiles` when submitting the job.
...
You could also specify the `requirements.txt` file using configuration [`python.requirements`](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-requirements>) or via [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `-pyreq` or `--pyRequirements` when submitting the job.
...
You could also specify the archive files using configuration [`python.archives`](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-archives>) or via [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `-pyarch` or `--pyArchives` when submitting the job.
...
You could also specify the Python interpreter using configuration [`python.executable`](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-executable>) or via [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `-pyexec` or `--pyExecutable` when submitting the job.
...
or specify it using configuration [`python.client.executable`](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-client-executable>), [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#submitting-pyflink-jobs>) `-pyclientexec` or `--pyClientExecutable`, environment variable [PYFLINK_CLIENT_EXECUTABLE](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/environment_variables/>)
...
You can refer to the SQL statement about [CREATE FUNCTION](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/table/sql/create/#create-function>) for more details on how to create Python user-defined functions using SQL statements.

The Python dependencies could then be specified via the Python [config options](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/python/python_config/#python-options>), such as **python.archives** , **python.files** , **python.requirements** , **python.client.executable** , **python.executable**. etc or through [command line arguments](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/cli/#usage>) when submitting the job.