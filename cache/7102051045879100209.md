...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/libs/gelly/overview/>).
...
Gelly is a Graph API for Flink. It contains a set of methods and utilities which aim to simplify the development of graph analysis applications in Flink. In Gelly, graphs can be transformed and modified using high-level functions similar to the ones provided by the batch processing API. Gelly provides methods to create, transform and modify graphs, as well as a library of graph algorithms.
  ...
  * [Graph API](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/graph_api/>)
  * [Iterative Graph Processing](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/iterative_graph_processing/>)
  * [Library Methods](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/library_methods/>)
  * [Graph Algorithms](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/graph_algorithms/>)
  * [Graph Generators](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/graph_generators/>)
  * [Bipartite Graphs](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/bipartite_graph/>)
...
Java
    ...
    &ltdependency&gt
        ...
        &ltartifactId&gtflink-gelly&lt/artifactId&gt
...
Scala
    ...
    &ltdependency&gt
        &ltgroupId&gtorg.apache.flink&lt/groupId&gt
        &ltartifactId&gtflink-gelly-scala_2.12&lt/artifactId&gt
        &ltversion&gt1.15.4&lt/version&gt
    &lt/dependency&gt

Copied to clipboard!

Note that Gelly is not part of the binary distribution. See [linking](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/configuration/overview/>) for instructions on packaging Gelly libraries into Flink user programs.
...
> "Apache Flink: Downloads") in the **opt** directory (for versions older than Flink 1.2 these can be manually downloaded from [Maven Central](<http://search.maven.org/#search%7cga%7c1%7cflink%20gelly>)). To run the Gelly examples the **flink-gelly** (for Java) or **flink-gelly-scala** (for Scala) jar must be copied to Flink’s **lib** directory.
...
The size of the graph is adjusted by the _\--scale_ and _\--edge_factor_ parameters. The [library generator](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/graph_generators/#rmat-graph>) provides access to additional configuration to adjust the power-law skew and random noise.
