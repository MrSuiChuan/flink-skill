...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/ops/state/checkpoints/>).
...
See [Checkpointing](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/datastream/fault-tolerance/checkpointing/>) for how to enable and configure checkpoints for your program.

To understand the differences between checkpoints and [savepoints](<//nightlies.apache.org/flink/flink-docs-master/docs/ops/state/savepoints/>) see [checkpoints vs. savepoints](<//nightlies.apache.org/flink/flink-docs-master/docs/ops/state/checkpoints_vs_savepoints/>).
...
Limitations of the `JobManagerCheckpointStorage`:
  ...
  * Irrespective of the configured maximal state size, the state cannot be larger than the Pekko frame size (see [Configuration](<//nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/>)).
