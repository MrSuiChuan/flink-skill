...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/flinkdev/building/>).

#  从源码构建 Flink #

本篇主题是如何从版本 1.20.3 的源码构建 Flink。

##  构建 Flink #

首先需要准备源码。可以[从发布版本下载源码](<

    //flink.apache.org/zh/downloads.html

>) 或者[从 Git 库克隆 Flink 源码](<https://github.com/apache/flink.git>)。
...
> 只是用 Java 库和 API 的用户可以 _忽略_ 这一部分。
