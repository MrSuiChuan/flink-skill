...
The Avro Schema Registry format can only be used in conjunction with the [Apache Kafka SQL connector](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/connectors/table/kafka/>) or the [Upsert Kafka SQL Connector](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/connectors/table/upsert-kafka/>).
