...
All [file systems](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/deployment/filesystems/overview/>) are pluggable. That means they can and should be used as plugins. To use a pluggable file system, copy the corresponding JAR file from the `opt` directory to a directory under `plugins` directory of your Flink distribution before starting Flink, e.g.
...
All [metric reporters](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/deployment/metric_reporters/>) that Flink provides can be used as plugins. See the [metrics](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/ops/metrics/>) documentation for more details.
