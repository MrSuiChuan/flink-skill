...
###  Prepare Flink Standalone cluster #
  ...
  1. Download [Flink 1.20.3](<https://archive.apache.org/dist/flink/flink-1.20.3/flink-1.20.3-bin-scala_2.12.tgz>) ，unzip and get flink-1.20.3 directory. Use the following command to navigate to the Flink directory and set FLINK_HOME to the directory where flink-1.20.3 is located.
...
##  Submit job with Flink CDC CLI #
  ...
  1. Download the binary compressed packages listed below and extract them to the directory `flink cdc-3.6.0'`：
[flink-cdc-3.6.0-bin.tar.gz](<https://www.apache.org/dyn/closer.lua/flink/flink-cdc-3.6.0/flink-cdc-3.6.0-bin.tar.gz>) flink-cdc-3.6.0 directory will contain four directory: `bin`, `lib`, `log`, and `conf`.
