...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/sinks/>).
...
If you are looking for pre-defined sink connectors, please check the [Connector Docs](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/datastream/overview/>).
...
The [ Sink ](<//github.com/apache/flink/blob/release-2.0/flink-core/src/main/java/org/apache/flink/api/connector/sink2/Sink.java>) API is a factory style interface to create the SinkWriter to write the data.
...
The core [ SinkWriter ](<//github.com/apache/flink/blob/release-2.0/flink-core/src/main/java/org/apache/flink/api/connector/sink2/SinkWriter.java>) API is responsible for writing data to downstream system.
...
The [ SupportsWriterState ](<//github.com/apache/flink/blob/release-2.0/flink-core/src/main/java/org/apache/flink/api/connector/sink2/SupportsWriterState.java>) interface is used to indicate that the sink supports writer state, which means that the sink can be recovered from a failure.
...
The [ SupportsCommitter ](<//github.com/apache/flink/blob/release-2.0/flink-core/src/main/java/org/apache/flink/api/connector/sink2/SupportsCommitter.java>) interface is used to indicate that the sink supports exactly-once semantics using a two-phase commit protocol.
...
The following figure shows the operator topology of using [ SupportsPreWriteTopology ](<//github.com/apache/flink/blob/release-2.0/flink-runtime/src/main/java/org/apache/flink/streaming/api/connector/sink2/SupportsPreWriteTopology.java>) :
...
The following figure shows the operator topology of using [ SupportsPreCommitTopology ](<//github.com/apache/flink/blob/release-2.0/flink-runtime/src/main/java/org/apache/flink/streaming/api/connector/sink2/SupportsPreCommitTopology.java>) :
...
The following figure shows the operator topology of using [ SupportsPostCommitTopology ](<//github.com/apache/flink/blob/release-2.0/flink-runtime/src/main/java/org/apache/flink/streaming/api/connector/sink2/SupportsPostCommitTopology.java>) :
