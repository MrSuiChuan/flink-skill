...
Currently, the Ogg format uses JSON format for serialization and deserialization. Please refer to [JSON Format documentation](<//nightlies.apache.org/flink/flink-docs-release-1.17/docs/connectors/table/formats/json/#data-type-mapping>) for more details about the data type mapping.