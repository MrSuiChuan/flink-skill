...
Accepted values are:
  ...
  * `fixeddelay`, `fixed-delay`: Fixed delay restart strategy. More details can be found [here](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/ops/state/task_failure_recovery#fixed-delay-restart-strategy>).
  * `failurerate`, `failure-rate`: Failure rate restart strategy. More details can be found [here](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/ops/state/task_failure_recovery#failure-rate-restart-strategy>).
  * `exponentialdelay`, `exponential-delay`: Exponential delay restart strategy. More details can be found [here](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/ops/state/task_failure_recovery#exponential-delay-restart-strategy>).
...
A region is a set of tasks that communicate via pipelined data exchanges. That is, batch data exchanges denote the boundaries of a region.
  ...
  * The data exchange types in a DataSet job are determined by the `ExecutionMode` which can be set through [ExecutionConfig](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/datastream/execution/execution_configuration/>).
