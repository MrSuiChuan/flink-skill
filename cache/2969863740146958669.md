...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/dev/datastream-v2/time-processing/processing_timer_service/>).
...
For a comprehensive explanation of processing time, please refer to the section on [Notions of Time: Event Time and Processing Time](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/concepts/time/#notions-of-time-event-time-and-processing-time>).
