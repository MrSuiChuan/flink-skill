...
Declare the following resources in your agent plan:
  ...
  * A [ChatModel](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/chat_models/>) for memory extraction and management
  * An [EmbeddingModel](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/embedding_models/>) for vector generation
  * A [VectorStore](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/vector_stores/>) for persistent storage
...
A named collection of memory items. Memory sets provide logical grouping and isolation of memories. See Context Isolation for details on how memories are scoped and isolated.
