...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/connectors/datastream/pulsar/>).
...
Flink 的流连接器并不会放到发行文件里面一同发布，阅读[此文档](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/configuration/overview/>)，了解如何将连接器添加到集群实例内。

##  Pulsar Source #

> Pulsar Source 基于 Flink 最新的[批流一体 API](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/datastream/sources/>) 进行开发。
...
[这篇文档](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/datastream/event-time/generating_watermarks/>)详细讲解了如何定义 `WatermarkStrategy`。
...
常见的升级步骤，请参阅[升级应用程序和 Flink 版本](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/ops/upgrading/>)。Pulsar 连接器没有在 Flink 端存储消费的状态，所有的消费信息都推送到了 Pulsar。所以需要注意下面的事项：
