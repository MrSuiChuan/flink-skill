...
Flink’s serializer [supports schema evolution for POJO types](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/fault-tolerance/serialization/schema_evolution/#pojo-types>).
...
At this point you know enough to get started coding and running a simple DataStream application. Clone the [ flink-training-repo ](<//github.com/apache/flink-training/tree/release-2.3/>) , and after following the instructions in the README, do the first exercise: [ Filtering a Stream (Ride Cleansing) ](<//github.com/apache/flink-training/blob/release-2.3//ride-cleansing>) .
...
##  Further Reading #
  ...
  * [Anatomy of a Flink Program](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/overview/#anatomy-of-a-flink-program>)
  * [Data Sources](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/overview/#data-sources>)
  * [Data Sinks](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/overview/#data-sinks>)
  * [DataStream Connectors](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/datastream/overview/>)
