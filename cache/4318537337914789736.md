...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/sql/materialized-table/quickstart/>).
...
这里的方法和[本地安装](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/getting-started/local_installation/>)中记录的步骤类似。Flink 可以运行在任何类 UNIX 的操作系统下面，例如：Linux, Mac OS X 和 Cygwin (for Windows)。
