#  [Sharing is caring - Catalogs in Flink SQL](</2020/07/23/sharing-is-caring-catalogs-in-flink-sql/>)

July 23, 2020 - Dawid Wysakowicz [(@dwysakowicz)](<https://twitter.com/dwysakowicz>)
...
The query above uses a `SYSTEM AS OF` [clause](<//nightlies.apache.org/flink/flink-docs-release-1.11/dev/table/streaming/temporal_tables.html#temporal-table>) for executing a temporal join. If you’d like to learn more about the different kind of joins you can do in Flink I highly encourage you to check [this documentation page](<//nightlies.apache.org/flink/flink-docs-release-1.11/dev/table/sql/queries.html#joins>).
...
You can get started with Flink and catalogs by reading [the docs](<//nightlies.apache.org/flink/flink-docs-release-1.11/dev/table/catalogs.html>). If you want to play around with Flink SQL (e.g. try out how catalogs work in Flink yourself), you can check [this demo](<https://github.com/fhueske/flink-sql-demo>) prepared by our colleagues Fabian and Timo — it runs in a dockerized environment, and we used it for the examples in this blog post.

[Want to contribute translation?](<https://cwiki.apache.org/confluence/display/FLINK/Flink+Translation+Specifications>)

[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2020-07-23-catalogs.md>)