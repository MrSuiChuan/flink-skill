...
The line of action for upgrading a streaming application or migrating an application to a different cluster is based on Flink’s [Savepoint](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/savepoints/>) feature. A savepoint is a consistent snapshot of the state of an application at a specific point in time.
...
See the [table state management section](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/concepts/overview/#state-management>) for more information.
...
Before starting the migration, please check that the jobs you are trying to migrate are following the best practices for [savepoints](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/savepoints/>).
...
For more details, please read the [savepoint documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/savepoints/>).
...
If you are unfamiliar with installing Flink in your cluster, please read the [deployment and cluster setup documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/deployment/resource-providers/standalone/overview/>).
...
For more details, please take a look at the [savepoint documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/savepoints/>).

##  Compatibility Table #

Savepoints are compatible across Flink versions as indicated by the table below:

Created with \ Resumed with | 1.16.x | 1.17.x | 1.18.x | 1.19.x | Limitations
---|---|---|---|---|---
**1.7.x** | O |  |  |  |
**1.8.x** | O | O | O | O |
**1.9.x** | O | O | O | O |
