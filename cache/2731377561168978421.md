...
###  Core #
  ...
  * Fully-automated [Job Lifecycle Management](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/custom-resource/job-management/>)
  ...
  * [Deployment Modes](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/custom-resource/overview/#application-deployments>):
    * Application cluster
    * Session cluster
    * Session job
  * Built-in [High Availability](<https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/ha/kubernetes_ha/>)
  * Extensible framework
    * [Custom validators](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/plugins/#custom-flink-resource-validators>)
    * [Custom resource listeners](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/plugins/#custom-flink-resource-listeners>)
  * Advanced [Configuration](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/configuration/>) management
    * Default configurations with dynamic updates
    * Per job configuration
    * Environment variables
  * POD augmentation via [Pod Templates](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/custom-resource/pod-template/>)
    * Native Kubernetes POD definitions
    * Layering (Base/JobManager/TaskManager overrides)
  * [Job Autoscaler](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/custom-resource/autoscaler/>)
    * Collect lag and utilization metrics
    * Scale job vertices to the ideal parallelism
    * Scale up and down as the load changes
  * [Snapshot management](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/custom-resource/snapshots/>)
    * Manage snapshots via Kubernetes CRs

###  Operations #

  * Operator [Metrics](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/metrics-logging/#metrics>)
  ...
  * Fully-customizable [Logging](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/metrics-logging/#logging>)
  ...
  * Flink Web UI and REST Endpoint Access
    ...
    * Dynamic [Ingress templates](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/ingress/>)
  * [Helm based installation](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/helm/>)
    * Automated [RBAC configuration](<//nightlies.apache.org/flink/flink-kubernetes-operator-docs-release-1.15/docs/operations/rbac/>)
