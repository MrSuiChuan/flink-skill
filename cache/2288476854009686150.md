#  [State TTL in Flink 1.8.0: How to Automatically Cleanup Application State in Apache Flink](</2019/05/17/state-ttl-in-flink-1.8.0-how-to-automatically-cleanup-application-state-in-apache-flink/>)

May 17, 2019 - Fabian Hueske [(@fhueske)](<https://twitter.com/fhueske>) Andrey Zagrebin
...
You can read more about how to use state TTL in the [Apache Flink documentation](<//nightlies.apache.org/flink/flink-docs-stable/dev/stream/state/state.html#state-time-to-live-ttl>).
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2019-05-17-state-ttl.md>)