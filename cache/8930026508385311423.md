...
ALTER statements are used to modify the definition of a table, view or function that has already been registered in the [Catalog](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/catalogs/>), or the definition of a catalog itself.
...
ALTER statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sqlclient/>).
...
Use `ADD` clause to add [columns](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#columns>), [constraints](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#primary-key>), a [watermark](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#watermark>), [partitions](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#partitioned-by>), and a [distribution](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/table/sql/create/#distributed>) to an existing table.
