...
To describe a Data Pipeline, the following parts are required:
  ...
  * [source](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/data-source/>)
  * [sink](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/data-sink/>)
  * pipeline
...
`route-mode` | The matching mode for [route](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/route/#route-mode>) rules. One of: `ALL_MATCH` (default, apply all matching rules) or `FIRST_MATCH` (apply only the first matching rule). | optional
`schema.change.behavior` | How to handle [changes in schema](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/>). One of: [`exception`](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/#exception-mode>), [`evolve`](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/#evolve-mode>), [`try_evolve`](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/#tryevolve-mode>), [`lenient`](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/#lenient-mode>) (default) or [`ignore`](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.6/docs/core-concept/schema-evolution/#ignore-mode>). | optional
