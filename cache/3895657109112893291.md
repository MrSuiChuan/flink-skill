...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/pubsub/>).
...
This connector provides a Source and Sink that can read from and write to [Google Cloud PubSub](<https://cloud.google.com/pubsub>). To use this connector, add the following dependency to your project:
    ...
    &ltdependency&gt
        ...
        &ltartifactId&gtflink-connector-gcp-pubsub_2.11&lt/artifactId&gt
