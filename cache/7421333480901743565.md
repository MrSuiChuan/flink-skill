...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/sql/reference/ddl/drop/>).

#  DROP 语句 #

DROP 语句可用于删除指定的 catalog，也可用于从当前或指定的 [Catalog](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/catalogs/>) 中删除一个已经注册的表、视图或函数。
...
可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/interfaces/sql-client/>) 中执行 DROP 语句。
...
See a dedicated page for [Materialized tables](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/sql/materialized-table/statements/#drop-materialized-table>).
