...
The command builds and runs the Python Table API program in a local mini cluster. You can also submit the Python Table API program to a remote cluster, you can refer [Job Submission Examples](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/deployment/cli/#submitting-pyflink-jobs>) for more details.
...
This should get you started with writing your own Flink Python Table API programs. You can also refer to [ PyFlink Examples ](<//github.com/apache/flink/blob/release-1.15/flink-python/pyflink/examples>) for more examples. To learn more about the Python Table API, you can refer [ Flink Python API Docs ](<//nightlies.apache.org/flink/flink-docs-release-1.15/api/python//>) for more details.