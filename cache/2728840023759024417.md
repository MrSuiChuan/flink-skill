...
If you are looking for pre-defined source connectors, please check the [Connector Docs](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/connectors/datastream/overview/>).
...
_Event Time_ assignment and _Watermark Generation_ happen as part of the data sources. The event streams leaving the Source Readers have event timestamps and (during streaming execution) contain watermarks. See [Timely Stream Processing](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/concepts/time/>) for an introduction to Event Time and Watermarks.
