#  [PyFlink: Introducing Python Support for UDFs in Flink's Table API](</2020/04/09/pyflink-introducing-python-support-for-udfs-in-flinks-table-api/>)

April 9, 2020 - Jincheng Sun [(@sunjincheng121)](<https://twitter.com/sunjincheng121>) Markos Sfikas [(@MarkSfik)](<https://twitter.com/MarkSfik>)
...
The command builds and runs the Python Table API program in a local mini-cluster. You can also submit the Python Table API program to a remote cluster using different command lines, (see more details [here](<//nightlies.apache.org/flink/flink-docs-release-1.10/ops/cli.html#job-submission-examples>)).
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2020-04-09-pyflink-udf-support-flink.md>)