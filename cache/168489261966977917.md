...
PyFlink JAR | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-parquet/1.18.1/flink-sql-parquet-1.18.1.jar>)
---
...
Avro schemas are defined using JSON. You can get more information about Avro schemas and types from the [Avro specification](<https://avro.apache.org/docs/1.10.0/spec.html>). This example uses an Avro schema example similar to the one described in the [official Avro tutorial](<https://avro.apache.org/docs/1.10.0/gettingstartedjava.html>):
...
The following example uses the example schema [ testdata.avsc ](<//github.com/apache/flink/blob/release-1.18/flink-formats/flink-parquet/src/test/resources/avro/testdata.avsc>) :
...
This example uses a simple Java POJO class [ Datum ](<//github.com/apache/flink/blob/release-1.18/flink-formats/flink-parquet/src/test/java/org/apache/flink/formats/parquet/avro/Datum.java>) :
