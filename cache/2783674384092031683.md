...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/release-notes/flink-2.0/>).
...
/jobs/:jobid/taskmanagers/:taskmanagerid/log-url | In their responses, the “host”, “subtasks.host” or “taskmanagers.host” property is removed.

##  List of removed CLI options #

  * sql-client.sh:
    * `-u,--update <SQL update statement>` is removed: Please use option `-f` to submit update. statement.
  * flink-client:
