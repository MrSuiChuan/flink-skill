...
SHOW statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-client/>).
...
**LIKE** Show all catalogs with a `LIKE` clause, whose name is similar to the `<sql_like_pattern>`.
...
Show all added jars in the session classloader which are added by [`ADD JAR`](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/utility/jar/#add-jar>) statements.

Attention Currently `SHOW JARS` statements only work in the [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-client/>) or [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-gateway/overview/>).
...
Attention Currently `SHOW JOBS` statements only work in the [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-client/>) or [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-gateway/overview/>).
...
**LIKE** Show all models with a `LIKE` clause, whose name is similar to the `<sql_like_pattern>`.
