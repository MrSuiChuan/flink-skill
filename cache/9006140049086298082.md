...
Definition Classes
  ...
  6. ####  def aggregate(agg: Aggregations, field: String): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  7. ####  def aggregate(agg: Aggregations, field: Int): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  8. ####  def apply[O](coGrouper: CoGroupFunction[L, R, O])(implicit arg0: TypeInformation[O], arg1: ClassTag[O]): [DataSet](<DataSet.html>)[O]
...
A RichCoGroupFunction can be used to access the broadcast variables and the org.apache.flink.api.common.functions.RuntimeContext.
  ...
  9. ####  def apply[O](fun: (Iterator[L], Iterator[R], Collector[O]) ⇒ Unit)(implicit arg0: TypeInformation[O], arg1: ClassTag[O]): [DataSet](<DataSet.html>)[O]
...
Creates a new [DataSet](<DataSet.html>) where the result for each pair of co-grouped element lists is the result of the given function. The function can output zero or more elements using the Collector which will form the result.
  ...
  10. ####  def apply[O](fun: (Iterator[L], Iterator[R]) ⇒ O)(implicit arg0: TypeInformation[O], arg1: ClassTag[O]): [DataSet](<DataSet.html>)[O]
...
Annotations
  ...
  13. ####  def coGroup[O](other: [DataSet](<DataSet.html>)[O])(implicit arg0: ClassTag[O]): [UnfinishedCoGroupOperation](<UnfinishedCoGroupOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  14. ####  def collect(): Seq[(Array[L], Array[R])]
...
org.apache.flink.api.java.Utils.CollectHelper
  ...
  15. ####  def combineGroup[R](fun: (Iterator[(Array[L], Array[R])], Collector[R]) ⇒ Unit)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  16. ####  def combineGroup[R](combiner: GroupCombineFunction[(Array[L], Array[R]), R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
org.apache.flink.api.java.Utils.CountHelper
  ...
  18. ####  def cross[O](other: [DataSet](<DataSet.html>)[O]): [CrossDataSet](<CrossDataSet.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  19. ####  def crossWithHuge[O](other: [DataSet](<DataSet.html>)[O]): [CrossDataSet](<CrossDataSet.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  20. ####  def crossWithTiny[O](other: [DataSet](<DataSet.html>)[O]): [CrossDataSet](<CrossDataSet.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  21. ####  def distinct(firstField: String, otherFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  22. ####  def distinct(fields: Int*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  23. ####  def distinct(): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  24. ####  def distinct[K](fun: ((Array[L], Array[R])) ⇒ K)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  27. ####  def filter(fun: ((Array[L], Array[R])) ⇒ Boolean): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  28. ####  def filter(filter: FilterFunction[(Array[L], Array[R])]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Annotations
  ...
  30. ####  def first(n: Int): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  31. ####  def flatMap[R](fun: ((Array[L], Array[R])) ⇒ TraversableOnce[R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  32. ####  def flatMap[R](fun: ((Array[L], Array[R]), Collector[R]) ⇒ Unit)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  33. ####  def flatMap[R](flatMapper: FlatMapFunction[(Array[L], Array[R]), R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  34. ####  def fullOuterJoin[O](other: [DataSet](<DataSet.html>)[O], strategy: JoinHint): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  35. ####  def fullOuterJoin[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  37. ####  def getExecutionEnvironment: [ExecutionEnvironment](<ExecutionEnvironment.html>)
...
Definition Classes
  ...
  39. ####  def getPartitioner[K](): Partitioner[K]
...
Annotations
  ...
  40. ####  def getType(): TypeInformation[(Array[L], Array[R])]
...
Definition Classes
  ...
  41. ####  def groupBy(firstField: String, otherFields: String*): [GroupedDataSet](<GroupedDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  42. ####  def groupBy(fields: Int*): [GroupedDataSet](<GroupedDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  43. ####  def groupBy[K](fun: ((Array[L], Array[R])) ⇒ K)(implicit arg0: TypeInformation[K]): [GroupedDataSet](<GroupedDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  46. ####  def iterate(maxIterations: Int)(stepFunction: ([DataSet](<DataSet.html>)[(Array[L], Array[R])]) ⇒ [DataSet](<DataSet.html>)[(Array[L], Array[R])]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  48. ####  def iterateDelta[R](workset: [DataSet](<DataSet.html>)[R], maxIterations: Int, keyFields: Array[String])(stepFunction: ([DataSet](<DataSet.html>)[(Array[L], Array[R])], [DataSet](<DataSet.html>)[R]) ⇒ ([DataSet](<DataSet.html>)[(Array[L], Array[R])], [DataSet](<DataSet.html>)[R]))(implicit arg0: ClassTag[R]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  50. ####  def iterateDelta[R](workset: [DataSet](<DataSet.html>)[R], maxIterations: Int, keyFields: Array[Int])(stepFunction: ([DataSet](<DataSet.html>)[(Array[L], Array[R])], [DataSet](<DataSet.html>)[R]) ⇒ ([DataSet](<DataSet.html>)[(Array[L], Array[R])], [DataSet](<DataSet.html>)[R]))(implicit arg0: ClassTag[R]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  51. ####  def iterateWithTermination(maxIterations: Int)(stepFunction: ([DataSet](<DataSet.html>)[(Array[L], Array[R])]) ⇒ ([DataSet](<DataSet.html>)[(Array[L], Array[R])], [DataSet](<DataSet.html>)[_])): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  52. ####  def join[O](other: [DataSet](<DataSet.html>)[O], strategy: JoinHint): [UnfinishedJoinOperation](<UnfinishedJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  53. ####  def join[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedJoinOperation](<UnfinishedJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  54. ####  def joinWithHuge[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedJoinOperation](<UnfinishedJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  55. ####  def joinWithTiny[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedJoinOperation](<UnfinishedJoinOperation.html>)[(Array[L], Array[R]), O]
...
Definition Classes
  ...
  56. ####  def leftOuterJoin[O](other: [DataSet](<DataSet.html>)[O], strategy: JoinHint): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
#fullOuterJoin
  ...
  57. ####  def leftOuterJoin[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
#fullOuterJoin
  ...
  58. ####  def map[R](fun: ((Array[L], Array[R])) ⇒ R)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  59. ####  def map[R](mapper: MapFunction[(Array[L], Array[R]), R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  60. ####  def mapPartition[R](fun: (Iterator[(Array[L], Array[R])]) ⇒ TraversableOnce[R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  61. ####  def mapPartition[R](fun: (Iterator[(Array[L], Array[R])], Collector[R]) ⇒ Unit)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  62. ####  def mapPartition[R](partitionMapper: MapPartitionFunction[(Array[L], Array[R]), R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  63. ####  def max(field: String): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  64. ####  def max(field: Int): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  65. ####  def maxBy(fields: Int*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  66. ####  def min(field: String): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  67. ####  def min(field: Int): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  68. ####  def minBy(fields: Int*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  69. ####  def minResources: ResourceSpec
...
Annotations
  ...
  70. ####  def name(name: String): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  74. ####  def output(outputFormat: OutputFormat[(Array[L], Array[R])]): DataSink[(Array[L], Array[R])]
...
Definition Classes
  ...
  75. ####  def partitionByHash[K](fun: ((Array[L], Array[R])) ⇒ K)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  76. ####  def partitionByHash(firstField: String, otherFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  77. ####  def partitionByHash(fields: Int*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  78. ####  def partitionByRange[K](fun: ((Array[L], Array[R])) ⇒ K)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  79. ####  def partitionByRange(firstField: String, otherFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  80. ####  def partitionByRange(fields: Int*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  81. ####  def partitionCustom[K](partitioner: Partitioner[K], fun: ((Array[L], Array[R])) ⇒ K)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  82. ####  def partitionCustom[K](partitioner: Partitioner[K], field: String)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  83. ####  def partitionCustom[K](partitioner: Partitioner[K], field: Int)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  84. ####  def preferredResources: ResourceSpec
...
Definition Classes
  ...
  86. ####  def printOnTaskManager(prefix: String): DataSink[(Array[L], Array[R])]
...
Definition Classes
  ...
  88. ####  def rebalance(): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  89. ####  def reduce(fun: ((Array[L], Array[R]), (Array[L], Array[R])) ⇒ (Array[L], Array[R])): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  90. ####  def reduce(reducer: ReduceFunction[(Array[L], Array[R])]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  91. ####  def reduceGroup[R](fun: (Iterator[(Array[L], Array[R])]) ⇒ R)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  92. ####  def reduceGroup[R](fun: (Iterator[(Array[L], Array[R])], Collector[R]) ⇒ Unit)(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  93. ####  def reduceGroup[R](reducer: GroupReduceFunction[(Array[L], Array[R]), R])(implicit arg0: TypeInformation[R], arg1: ClassTag[R]): [DataSet](<DataSet.html>)[R]
...
Definition Classes
  ...
  94. ####  def registerAggregator(name: String, aggregator: Aggregator[_]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Annotations
  ...
  95. ####  def rightOuterJoin[O](other: [DataSet](<DataSet.html>)[O], strategy: JoinHint): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
#fullOuterJoin
  ...
  96. ####  def rightOuterJoin[O](other: [DataSet](<DataSet.html>)[O]): [UnfinishedOuterJoinOperation](<UnfinishedOuterJoinOperation.html>)[(Array[L], Array[R]), O]
...
#fullOuterJoin
  ...
  97. ####  def setParallelism(parallelism: Int): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  98. ####  def sortFirstGroup(field: String, order: Order): [CoGroupDataSet](<>)[L, R]

Adds a secondary sort key to the first input of this [CoGroupDataSet](<>).

  99. ####  def sortFirstGroup(field: Int, order: Order): [CoGroupDataSet](<>)[L, R]
...
This only works on Tuple DataSets.
  ...
  100. ####  def sortPartition[K](fun: ((Array[L], Array[R])) ⇒ K, order: Order)(implicit arg0: TypeInformation[K]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  101. ####  def sortPartition(field: String, order: Order): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  102. ####  def sortPartition(field: Int, order: Order): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  103. ####  def sortSecondGroup(field: String, order: Order): [CoGroupDataSet](<>)[L, R]

Adds a secondary sort key to the second input of this [CoGroupDataSet](<>).

  104. ####  def sortSecondGroup(field: Int, order: Order): [CoGroupDataSet](<>)[L, R]
...
This only works on Tuple DataSets.
  ...
  105. ####  def sum(field: String): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  106. ####  def sum(field: Int): [AggregateDataSet](<AggregateDataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  109. ####  def union(other: [DataSet](<DataSet.html>)[(Array[L], Array[R])]): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Annotations
  ...
  113. ####  def withBroadcastSet(data: [DataSet](<DataSet.html>)[_], name: String): [DataSet](<DataSet.html>)[(Array[L], Array[R])]
...
Definition Classes
  ...
  114. ####  def withForwardedFields(forwardedFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]

Definition Classes
    [DataSet](<DataSet.html>)

  115. ####  def withForwardedFieldsFirst(forwardedFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]

Definition Classes
    [DataSet](<DataSet.html>)

  116. ####  def withForwardedFieldsSecond(forwardedFields: String*): [DataSet](<DataSet.html>)[(Array[L], Array[R])]

Definition Classes
    [DataSet](<DataSet.html>)

  117. ####  def withParameters(parameters: Configuration): [DataSet](<DataSet.html>)[(Array[L], Array[R])]

Definition Classes
    [DataSet](<DataSet.html>)

  118. ####  def withPartitioner[K](partitioner: Partitioner[K])(implicit arg0: TypeInformation[K]): [CoGroupDataSet](<>)[L, R]

  119. ####  def write(outputFormat: FileOutputFormat[(Array[L], Array[R])], filePath: String, writeMode: WriteMode = null): DataSink[(Array[L], Array[R])]
...
Definition Classes
  ...
  120. ####  def writeAsCsv(filePath: String, rowDelimiter: String = ..., fieldDelimiter: String = ..., writeMode: WriteMode = null): DataSink[(Array[L], Array[R])]
...
org.apache.flink.api.java.DataSet#writeAsText(String)
  ...
  121. ####  def writeAsText(filePath: String, writeMode: WriteMode = null): DataSink[(Array[L], Array[R])]
