...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/dataset/hadoop_compatibility/>).
...
You can:
  ...
  * use Hadoop’s `Writable` [data types](<//nightlies.apache.org/flink/flink-docs-release-1.13/docs/dev/serialization/types_serialization/#supported-data-types>) in Flink programs.
...
This document shows how to use existing Hadoop MapReduce code with Flink. Please refer to the [Connecting to other systems](<//nightlies.apache.org/flink/flink-docs-release-1.13/docs/deployment/filesystems/overview/#hadoop-file-system-hdfs-and-its-other-implementations>) guide for reading from Hadoop supported file systems.
