...
ALTER statements are used to modify the definition of a table, view or function that has already been registered in the [Catalog](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/catalogs/>), or the definition of a catalog itself.
...
ALTER statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-client/>).
...
Use `ADD` clause to add [columns](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#columns>), [constraints](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#primary-key>), a [watermark](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#watermark>), [partitions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#partitioned-by>), and a [distribution](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#distributed>) to an existing table.
...
See a dedicated page for [Materialized tables](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/materialized-table/statements/#alter-materialized-table>).
...
If the language tag is JAVA/SCALA, the identifier is the full classpath of the UDF. For the implementation of Java/Scala UDF, please refer to [User-defined Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/udfs/>) for more details.

If the language tag is PYTHON, the identifier is the fully qualified name of the UDF, e.g. `pyflink.table.tests.test_udf.add`. For the implementation of Python UDF, please refer to [Python UDFs](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/python-udfs/>) for more details.
