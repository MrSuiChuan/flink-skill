...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/materialized-table/deployment/>).
...
#  Architecture Introduction #
  ...
  * **Client** : Could be any client that can interact with [Flink SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql-gateway/overview/>), such as [SQL Client](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sqlclient/>), [Flink JDBC Driver](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/jdbcdriver/>) and so on.
...
Materialized Table refresh jobs currently support execution in these cluster environments:
  ...
  * [Standalone clusters](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/deployment/resource-providers/standalone/overview/>)
  * [YARN clusters](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/deployment/resource-providers/yarn/>)
  * [Kubernetes clusters](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/deployment/resource-providers/native_kubernetes/>)
...
Refer to [Catalog Store](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/catalogs/#catalog-store>) for details.
