...
Note that the streaming connectors are currently **NOT** part of the binary distribution. See how to link with them for cluster execution [here](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/configuration/overview/>). A driver dependency is also required to connect to a specified database. Please consult your database documentation on how to add the corresponding driver.

##  JDBC Source #

Configuration goes as follow (see also [ JdbcSource javadoc ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/source/JdbcSource.html>) and [ JdbcSourceBuilder javadoc ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/source/JdbcSourceBuilder.html>) ).
...
See [ ContinuousUnBoundingSettings javadoc ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/utils/ContinuousUnBoundingSettings.html>) for more details.
...
The SQL DML statements are executed in batches, which can optionally be configured with the following instance (see also [ JdbcExecutionOptions javadoc ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/JdbcExecutionOptions.html>) )
...
The connection to the database is configured with a `JdbcConnectionOptions` instance. Please see [ JdbcConnectionOptions javadoc ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/JdbcConnectionOptions.html>) for details
...
To use it, create a sink using `exactlyOnceSink()` method as above and additionally provide:
  ...
  * [ exactly-once options ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/JdbcExactlyOnceOptions.html>)
  * [ execution options ](<//nightlies.apache.org/flink/flink-docs-release-1.19/api/java//org/apache/flink/connector/jdbc/JdbcExecutionOptions.html>)
