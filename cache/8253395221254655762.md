...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/deployment/advanced/logging/>).
...
The log files can be accessed via the Job-/TaskManager pages of the WebUI. The used [Resource Provider](<//nightlies.apache.org/flink/flink-docs-master/docs/deployment/overview/>) (e.g., YARN) may provide additional means of accessing them.
...
The following [logging-related configuration options](<//nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/#jvm-and-logging-options>) are available:
