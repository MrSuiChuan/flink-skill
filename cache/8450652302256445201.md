...
> Do not use Sensory Memory for data that needs to persist across multiple agent runs. Use Short-Term Memory or [Long-Term Memory](<//nightlies.apache.org/flink/flink-agents-docs-main/docs/development/memory/long_term_memory/>) instead.
...
> Short-Term Memory is designed for complete original data retrival. For use case that need get the concise and highly related context, consider using [Long-Term Memory](<//nightlies.apache.org/flink/flink-agents-docs-main/docs/development/memory/long_term_memory/>) instead.
...
**Python** is restricted to recursively _checkpoint-stable_ values:
