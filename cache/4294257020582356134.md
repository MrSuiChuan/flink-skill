...
可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 中执行 SHOW 语句。
...
展示所有通过 [`ADD JAR`](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/utility/jar/#add-jar>) 语句加入到 session classloader 中的 jar。

Attention 当前 SHOW JARS 命令只能在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 或者 [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-gateway/overview/>) 中使用.
...
Attention 当前 SHOW JOBS 命令只能在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 或者 [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-gateway/overview/>) 中使用.
