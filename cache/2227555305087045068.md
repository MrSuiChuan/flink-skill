...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/connectors/table/formats/protobuf/>).
...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-protobuf/1.20.3/flink-sql-protobuf-1.20.3.jar>)
---|---
...
Below is the proto definition file.
  ...
  3. Finally you should provide the `jar` in your classpath, e.g. pass it using `-j` in [sql-client](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sqlclient/>)
