...
Version | PyFlink JAR | flink-connector-aws-kinesis-streams | There is no SQL jar (yet) available for Flink version 2.2.
---|---
See [Python dependency management](<//nightlies.apache.org/flink/flink-docs-release-2.2//docs/dev/python/dependency_management/#jar-dependencies>) for more details on how to use JARs in PyFlink.
...
AvroDeserializationSchema
    ...
    &ltdependency&gt
        ...
        &ltversion&gt2.2.1&lt/version&gt
    &lt/dependency&gt
...
> The old Kinesis source `org.apache.flink.streaming.connectors.kinesis.FlinkKinesisConsumer` is deprecated and may be removed with a future release of Flink, please use [Kinesis Source](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/datastream/kinesis/#kinesis-streams-source>) instead.
...
The Kinesis Sink provides some metrics through Flink’s [metrics system](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/metrics/>) to analyze the behavior of the connector. A list of all exposed metrics may be found [here](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/ops/metrics/#kinesis-sink>).
...
> The old Kinesis sink `org.apache.flink.streaming.connectors.kinesis.FlinkKinesisProducer` is deprecated and may be removed with a future release of Flink, please use [Kinesis Sink](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/datastream/kinesis/#kinesis-streams-sink>) instead.
