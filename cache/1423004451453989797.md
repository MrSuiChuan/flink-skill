...
##  Submit job with Flink CDC CLI #
  ...
  1. Download the binary compressed packages listed below and extract them to the directory `flink-cdc-3.6.0`： [flink-cdc-3.6.0-bin.tar.gz](<https://www.apache.org/dyn/closer.lua/flink/flink-cdc-3.6.0/flink-cdc-3.6.0-bin.tar.gz>) `flink-cdc-3.6.0` directory will contain four directories: `bin`, `lib`, `log`, and `conf`.
