...
Alternatively, it may be based on an existing schema using the [LIKE Clause](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/sql/create/#create-table>).
