...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/deployment/filesystems/plugins/>).
...
All [file systems](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/deployment/filesystems/overview/>) are pluggable. That means they can and should be used as plugins. To use a pluggable file system, copy the corresponding JAR file from the `opt` directory to a directory under `plugins` directory of your Flink distribution before starting Flink, e.g.
...
All [metric reporters](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/deployment/metric_reporters/>) that Flink provides can be used as plugins. See the [metrics](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/ops/metrics/>) documentation for more details.
