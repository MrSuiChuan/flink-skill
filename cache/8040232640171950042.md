...
Materialized Table refresh jobs currently support execution in these cluster environments:
  ...
  * [Standalone clusters](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/resource-providers/standalone/overview/>)
  * [YARN clusters](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/resource-providers/yarn/>)
  * [Kubernetes clusters](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/resource-providers/native_kubernetes/>)
...
Refer to [Catalog Store](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/table/catalogs/#catalog-store>) for details.
