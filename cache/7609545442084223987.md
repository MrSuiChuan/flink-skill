...
EXPLAIN statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sqlclient/>).
...
For query syntax, please refer to [Queries](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/queries/overview/>) page. For insert syntax, please refer to [INSERT](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/insert/>) page.