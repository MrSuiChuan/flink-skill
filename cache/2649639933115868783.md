...
Flink SQL provides the `ML_PREDICT` table-valued function (TVF) to perform model inference in SQL queries. This function allows you to apply machine learning models to your data streams directly in SQL. See [Model Creation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#create-model>) about how to create a model.
...
###  Related Statements #
  ...
  * [Model Creation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/create/#create-model>)
  * [Model Alteration](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/reference/ddl/alter/#alter-model>)

###  Supported Model Providers #

Flink currently supports the following model providers:

  * **OpenAI** : For calling OpenAI API services. See [OpenAI Model Documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/models/openai/>) for details.
  * **Triton** : For calling NVIDIA Triton Inference Server. See [Triton Model Documentation](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/connectors/models/triton/>) for details.
