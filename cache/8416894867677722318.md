...
You can access the metric system from a [Python user-defined function](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/python/table/udfs/python_udfs/>) by calling `function_context.get_metric_group()` in the `open` method. The `get_metric_group()` method returns a `MetricGroup` object on which you can create and register new metrics.
...
You can refer to the Java metric document for more details on [Scope definition](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#Scope>).
...
You can refer to the Java metric document for more details on [System Scope](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#system-scope>).

###  List of all Variables #

You can refer to the Java metric document for more details on [List of all Variables](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#list-of-all-variables>).
...
You can refer to the Java metric document for more details on the following sections:
  ...
  * [Reporter](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/deployment/metric_reporters/>).
  * [System metrics](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#system-metrics>).
  * [Latency tracking](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#latency-tracking>).
  * [REST API integration](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#rest-api-integration>).
  * [Dashboard integration](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/metrics/#dashboard-integration>).
