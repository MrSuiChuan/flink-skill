...
DROP statements are used to remove a catalog with the given catalog name or to remove a registered table/view/function from the current or specified [Catalog](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/catalogs/>).
...
DROP statements can be in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/interfaces/sql-client/>).
...
See a dedicated page for [Materialized tables](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/sql/materialized-table/statements/#drop-materialized-table>).
