...
Follow the [installation](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/installation/>) instructions to setup Flink and the Flink Agents.
