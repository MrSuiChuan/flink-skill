...
Here, we provide background on both operator variants and outline their usage. The [programming guide](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/dataset/overview/>) explains how to implement the operators in both Scala and Java. We also support both **vertex-centric and gather-sum-apply iterations** through Flink’s graph processing API, [Gelly](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/libs/gelly/overview/>).
...
> See the **[Programming Guide](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/dataset/overview/>)** for details and code examples.
