...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-avro/2.1.1/flink-sql-avro-2.1.1.jar>)
---|---
...
| optional | yes | (none) | String | For [Filesystem](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/connectors/table/filesystem/>) only, the compression codec for avro. Snappy compression as default. The valid enumerations are: null, deflate, snappy, bzip2, xz.
