...
The method here is similar to the steps recorded in [local installation](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/try-flink/local_installation/>). Flink can run on any UNIX-like operating system, such as Linux, Mac OS X, and Cygwin (for Windows).
