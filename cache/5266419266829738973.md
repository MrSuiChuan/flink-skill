#  [Apache Flink Kubernetes Operator 1.6.0 Release Announcement](</2023/08/15/apache-flink-kubernetes-operator-1.6.0-release-announcement/>)

August 15, 2023 - Gyula Fora [(@GyulaFora)](<https://twitter.com/GyulaFora>)
...
The operator now supports setting default configuration on a per-namespace and per-flink version level. This allows users for example to set config defaults differently for Flink 1.18 (enable adaptive scheduler by default)
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2023-08-15-release-kubernetes-operator-1.6.0.md>)