...
[ Quick Start ](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.5/docs/get-started/introduction/>)
...
Flink CDC provides a series of quick start demos without any dependencies or java code. A Linux or MacOS computer with Docker installed is enough. Please check out our [Quick Start](<//nightlies.apache.org/flink/flink-cdc-docs-release-3.5/docs/get-started/introduction/>) for more information.
