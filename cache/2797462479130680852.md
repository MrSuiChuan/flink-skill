...
UnivariateFeatureSelector supports different selection modes:
  ...
  * fdr: uses the [Benjamini-Hochberg procedure](<https://en.wikipedia.org/wiki/False_discovery_rate#
        Benjamini.E2.80.93Hochberg_procedure>) to choose all features whose false discovery rate is below a threshold.
