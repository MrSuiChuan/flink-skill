This documentation is for an out-of-date version of Apache Flink. We recommend you use [the latest stable version](<//nightlies.apache.org/flink/flink-docs-stable/dev/stream/state/custom_serialization.html>).
...
[ ](<//ci.apache.org/projects/flink/flink-docs-release-1.10/zh/dev/stream/state/custom_serialization.html>)

# Custom Serialization for Managed State

**This documentation is for an out-of-date version of Apache Flink. We recommend you use[the latest stable version](<https://nightlies.apache.org/flink/flink-docs-stable/dev/stream/state/custom_serialization.html>).**
