...
You can download the release [here](<http://flink.apache.org/downloads.html#preview>) and check out the latest documentation [here](<//nightlies.apache.org/flink/flink-docs-master/>). Feedback through the Flink [mailing lists](<http://flink.apache.org/community.html#mailing-lists>) is, as always, very welcome!
...
Check out the Table guide for Java and Scala [here](<//nightlies.apache.org/flink/flink-docs-master/apis/batch/libs/table.html>).
...
Gelly internally builds on top of Flink’s [delta iterations](<//nightlies.apache.org/flink/flink-docs-master/apis/batch/iterations.html>). Iterative graph algorithms are executed leveraging mutable state, achieving similar performance with specialized graph processing systems.

Gelly will eventually subsume Spargel, Flink’s Pregel-like API. Check out the Gelly guide [here](<//nightlies.apache.org/flink/flink-docs-master/apis/batch/libs/gelly.html>).
...
Get started with Flink on Tez [here](<//nightlies.apache.org/flink/flink-docs-master/setup/flink_on_tez.html>).
...
This release introduces stream processing with exacly-once delivery guarantees for Flink streaming programs that analyze streaming sources that are persisted by [Apache Kafka](<http://kafka.apache.org>). The system is internally tracking the Kafka offsets to ensure that Flink can pick up data from Kafka where it left off in case of an failure.

Read [here](<//nightlies.apache.org/flink/flink-docs-master/apis/streaming_guide.html#apache-kafka>) on how to use the persistent Kafka source.
...
See the YARN docs [here](<//nightlies.apache.org/flink/flink-docs-master/setup/yarn_setup.html>).
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2015-04-13-release-0.9.0-milestone1.md>)