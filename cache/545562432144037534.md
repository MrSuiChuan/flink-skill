...
See [Checkpointing](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/datastream/fault-tolerance/checkpointing/>) for how to enable and configure checkpoints for your program.

To understand the differences between checkpoints and [savepoints](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/savepoints/>) see [checkpoints vs. savepoints](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/ops/state/checkpoints_vs_savepoints/>).
...
Limitations of the `JobManagerCheckpointStorage`:
  ...
  * Irrespective of the configured maximal state size, the state cannot be larger than the Pekko frame size (see [Configuration](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/deployment/config/>)).
