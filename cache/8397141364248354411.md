...
The Kinesis connector is not part of the binary distribution. See how to link with it for cluster execution [here](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/configuration/overview/>).
...
> Refer to the [Kinesis Datastream API](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/connectors/datastream/kinesis/>) documentation for more detailed description of features.
