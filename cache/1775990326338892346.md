...
Once the [project folder and files](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/configuration/overview/#getting-started>) have been created, we recommend that you import this project into your IDE for developing and testing.
...
To learn more about how to deploy Flink jobs, check out the [deployment guide](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/deployment/cli/>).