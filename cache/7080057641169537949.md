...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/dev/table/materialized-table/quickstart/>).
...
#  架构介绍 #
  ...
  * **Client** : 可以是任何能够与 [Flink SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sql-gateway/overview/>) 交互的客户端，如 [SQL 客户端](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sqlclient/>)、[Flink JDBC 驱动](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/jdbcdriver/>) 等。
...
这里的方法和[本地安装](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/try-flink/local_installation/>)中记录的步骤类似。Flink 可以运行在任何类 UNIX 的操作系统下面，例如：Linux, Mac OS X 和 Cygwin (for Windows)。
