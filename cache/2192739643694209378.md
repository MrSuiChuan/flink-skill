...
For information on how to set up Flink’s trace reporters please take a look at the [trace reporters documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/deployment/trace_reporters/>).
...
(optional - currently only supported by RocksDB Incremental) | The aggregated (max and sum) across all subtasks duration of downloading state files from the DFS.
