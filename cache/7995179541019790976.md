...
This walkthrough requires installing Flink ML Python SDK, which is available on [PyPi](<https://pypi.org/project/apache-flink-ml/>) and can be easily installed using pip.
...
Please download [Flink ML Python source](<https://flink.apache.org/downloads.html>) and extract the jar files into Flink’s library folder.
