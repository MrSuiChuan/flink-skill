...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/dev/configuration/gradle/>).
...
创建[项目目录和文件](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/configuration/overview/#getting-started>)后，我们建议您将此项目导入到 IDE 进行开发和测试。
...
要了解有关如何部署 Flink 作业的更多信息，请查看[部署指南](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/deployment/cli/>)。