...
We encourage everyone to download the release and check out the [documentation](<//nightlies.apache.org/flink/flink-docs-release-1.3/>). Feedback through the [Flink mailing lists](<http://flink.apache.org/community.html#mailing-lists>) is, as always, gladly encouraged!
...
#  DataStream API #
  ...
  * **Side Outputs** : This change allows users to have more than one output stream for an operator. Operator metadata, internal system information (debugging, performance etc.) or rejected/late elements are potential use-cases for this new API feature. **The Window operator is now using this new feature for late window elements** ([Side Outputs Documentation](<//nightlies.apache.org/flink/flink-docs-release-1.3/dev/stream/side_output.html>), [FLINK-4460](<https://issues.apache.org/jira/browse/FLINK-4460>)).
...
#  Deployment and Tooling #
  ...
  * **Flink HistoryServer** : Flink’s [HistoryServer](<//nightlies.apache.org/flink/flink-docs-release-1.3/monitoring/historyserver.html>) now allows you to query the status and statistics of completed jobs that have been archived by a JobManager ([FLINK-1579](<https://issues.apache.org/jira/browse/FLINK-1579>)).
  ...
  * **Datadog HTTP Metrics Reporter** : Datadog is a widely-used metrics system, and Flink now offers a [Datadog reporter](<//nightlies.apache.org/flink/flink-docs-release-1.3/monitoring/metrics.html#datadog-orgapacheflinkmetricsdatadogdatadoghttpreporter>) that contacts the Datadog http endpoint directly ([FLINK-6013](<https://issues.apache.org/jira/browse/FLINK-6013>)).
...
→ See [Configuring the Network Buffers](<//nightlies.apache.org/flink/flink-docs-release-1.3/setup/config.html#configuring-the-network-buffers>) in the Flink documentation.
...
→ See [the Flink documentation](<//nightlies.apache.org/flink/flink-docs-release-1.3/dev/table_api.html#group-windows>) for details about these features.
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2017-06-01-release-1.3.0.md>)