...
Open the `build.gradle` file in your project directory and add the following in the dependencies block.
    ...
    testCompile "org.apache.flink:flink-test-utils:2.2.1"
...
For more information on how to use these utilities, check out the section on [DataStream API testing](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/testing/>)
...
Open the `build.gradle` file in your project directory and add the following in the dependencies block.
    ...
    testCompile "org.apache.flink:flink-table-test-utils:2.2.1"
