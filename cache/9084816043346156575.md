...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/formats/avro-confluent/>).
...
The Avro Schema Registry format can only be used in conjunction with the [Apache Kafka SQL connector](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/kafka/>) or the [Upsert Kafka SQL Connector](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/connectors/table/upsert-kafka/>).
