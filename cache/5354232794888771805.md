...
In this section you will learn about how to use broadcast state in practise. Please refer to [Stateful Stream Processing](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/concepts/stateful-stream-processing/>) to learn about the concepts behind stateful stream processing.
