...
Support for Java Records was added in Flink 1.19 ([FLINK-32380](<https://issues.apache.org/jira/browse/FLINK-32380>)). Java records are handled as [POJO types](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/datastream/fault-tolerance/serialization/types_serialization/#pojos>) and serialized via their canonical constructor.
...
These should be configured via the [env.java.opts.all](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#env-java-opts-all>) option.
