...
Also, have a look at the [Documentation Style Guide](</how-to-contribute/documentation-style-guide/>) for some guidance on how to write accessible, consistent and inclusive documentation.
...
_NOTE: The Flink community is still in the process of translating Chinese documentations, some documents may not have been translated yet. If the document you are updating is not translated yet, you can just copy the English changes to the Chinese document._
...
It is also possible to attach a patch to a [Jira](<https://issues.apache.org/jira/projects/FLINK/issues/>) issue.

[Want to contribute translation?](<https://cwiki.apache.org/confluence/display/FLINK/Flink+Translation+Specifications>)

[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/how-to-contribute/contribute-documentation.md>)