...
This release includes 3 bug fixes, vulnerability fixes, and minor improvements for Flink-Agents 0.2. Below you will find a list of all bug fixes and improvements (excluding improvements to the build infrastructure and build stability). For a complete list of all changes, please see: [ISSUE](<https://github.com/apache/flink-agents/issues?q=is%3Aissue%20state%3Aclosed%20label%3AfixVersion%2F0.2.1>).
...
##  Bug
  ...
  * [[412](<https://github.com/apache/flink-agents/issues/412>)] - Failed to connect to remote mcp server that does not support prompts
  * [[538](<https://github.com/apache/flink-agents/issues/538>)] - Java agents fail to connect to MCP servers that do not support prompts
  * [[532](<https://github.com/apache/flink-agents/pull/532>)] - Fix MCPTool Jackson deserialization by ignoring unknown properties

##  Improvement

  * [[568](<https://github.com/apache/flink-agents/issues/568>)] - Support pretty-printed JSON format for FileEvent logs
  * [[519](<https://github.com/apache/flink-agents/issues/519>)] - Reduce size of flink-agents wheel

##  Technical Debt

  * [[96](<https://github.com/apache/flink-agents/issues/96>)] - Improve observability of ci

[Want to contribute translation?](<https://cwiki.apache.org/confluence/display/FLINK/Flink+Translation+Specifications>)

[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2026-03-25-release-flink-agents-0.2.1.md>)