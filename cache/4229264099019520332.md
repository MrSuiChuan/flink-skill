...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/connectors/models/triton/>).
...
输入类型 | 输出类型 | 说明
---|---|---
BOOLEAN, TINYINT, SMALLINT, INT, BIGINT | BOOLEAN, TINYINT, SMALLINT, INT, BIGINT | 整数类型推理
FLOAT, DOUBLE | FLOAT, DOUBLE | 浮点类型推理
STRING | STRING | 文本到文本推理（分类、生成等）
ARRAY<numeric types> | ARRAY<numeric types> | 数组推理（向量、张量等）。支持数值类型的数组。
...
##  更多信息 #
  ...
  * [Flink 异步 I/O](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/datastream/operators/asyncio/>)
  * [Flink 指标](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/ops/metrics/>)
