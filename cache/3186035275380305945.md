#  [Stateful Functions 2.0 - An Event-driven Database on Apache Flink](</2020/04/07/stateful-functions-2.0-an-event-driven-database-on-apache-flink/>)

April 7, 2020 - Stephan Ewen [(@stephanewen)](<https://twitter.com/stephanewen>)
...
_**Fig.1:** A ride-sharing app as a Stateful Functions example._
...
_**Fig.2:** In Stateful Functions 2.0, functions are stateless and state access is part of the function invocation._
...
_**Fig.3:** A module declaring a remote endpoint and a function type._





_**Fig.4:** A Python implementation of a simple classifier function._
...
> _Effectively, Flink takes the role of the database, but tailored towards event-driven functions and services. It integrates state storage with the messaging between (and the invocations of) functions and services. Because of this, Stateful Functions 2.0 can be thought of as an “Event-driven Database” on Apache Flink._
...
_**Fig.5:** Stateful Functions 2.0 inverts the relationship between database and application._
...
_**Fig.6:** The event-driven database integrates state access and messaging, guaranteeing consistency._
...
To create a savepoint for a Stateful Functions program, check out the [State Bootstrapping API](<//nightlies.apache.org/flink/flink-statefun-docs-release-2.0/deployment-and-operations/state-bootstrap.html>) that is part of StateFun 2.0. The State Bootstrapping API uses Flink’s [DataSet API]({{ site.docs-stable }}/dev/batch/), but we plan to expand this to use SQL in the next versions.

##  Try it out and get involved! #

We hope that we could convey some of the excitement we feel about Stateful Functions. If we managed to pique your curiosity, try it out — for example, starting with [this walkthrough](<//nightlies.apache.org/flink/flink-statefun-docs-release-2.0/getting-started/python_walkthrough.html>).
...
To follow the project and learn more, please check out these resources:
  ...
  * Docs: [//nightlies.apache.org/flink/flink-statefun-docs-release-2.0/](<//nightlies.apache.org/flink/flink-statefun-docs-release-2.0/>)
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2020-04-07-release-statefun-2.0.0.md>)