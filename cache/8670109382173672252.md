...
The key features of Apache Flink Agents include:
  ...
  * **Multi-Language Supports** : Provides native APIs in Python, Java, and a declarative YAML API, enabling seamless integration into diverse development environments and allowing teams to use their preferred programming style. You can even mix languages, authoring actions, tools, and events in one and running them in an agent built in the other. For guidance on choosing Java or Python, see [Should I choose Java or Python?](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/faq/faq/#q3-should-i-choose-java-or-python>).
...
To get started with Apache Flink Agents, you can checkout the following quickstarts:
  ...
  * [Workflow Agent Quickstart](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/quickstart/workflow_agent/>)
  * [ReAct Agent Quickstart](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/quickstart/react_agent/>)
  * [Skills Agent Quickstart](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/quickstart/skills_agent/>)
  * [YAML Agent Quickstart](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/quickstart/yaml_agent/>)