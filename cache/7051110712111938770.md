...
See the [CREATE FUNCTION](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/reference/ddl/create/#create-function>) documentation for the full syntax.
...
Writing user-defined functions requires Java, Scala, or Python programming. For detailed information on how to develop UDFs, see the Table API documentation:
  ...
  * [User-Defined Functions Overview](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/dev/table/functions/udfs/>): How to implement and register scalar, table, and aggregate functions.
  * [Process Table Functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/dev/table/functions/ptfs/>): Advanced table functions for complex event processing.
