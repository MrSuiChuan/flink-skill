...
The log files can be accessed via the Job-/TaskManager pages of the WebUI. The used [Resource Provider](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/deployment/overview/>) (e.g., YARN) may provide additional means of accessing them.
