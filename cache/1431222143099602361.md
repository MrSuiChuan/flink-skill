...
For more details about the different ways to create a `TableEnvironment`, please refer to the [TableEnvironment Documentation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/table/table_environment/#create-a-tableenvironment>).

`TableEnvironment` is responsible for:

  * `Table` management: Creating Tables, listing Tables, [Conversion between Table and DataStream](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/data_stream_api/#converting-between-datastream-and-table>), etc.
  * User-defined function management: User-defined function registration, dropping, listing, etc. See [General User-defined Functions](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/table/udfs/python_udfs/>) and [Vectorized User-defined Functions](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/table/udfs/vectorized_python_udfs/>) for more details about Python user-defined functions.
  * Executing [SQL](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/overview/>) queries: See Write SQL Queries for more details.
  * Job configuration: See [Python Configuration](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/python_config/>) for more details.
  * Python dependency management: See [Dependency Management](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/dependency_management/>) for more details.
...
The [Table API](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/?code_tab=python>) documentation describes all Table API operations that are supported on streaming and batch tables.
...
The [Row-based Operations](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/#row-based-operations>) are also supported in Python Table API, which include [Map Operation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/#row-based-operations>), [FlatMap Operation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/#flatmap>), [Aggregate Operation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/#aggregate>) and [FlatAggregate Operation](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/tableapi/#flataggregate>).
...
The [SQL](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/overview/>) documentation describes Flink’s SQL support for streaming and batch tables.
...
Note It will trigger the materialization of the table and collect table content to the memory of the client, it’s a good practice to limit the number of rows collected via [ Table.limit ](<//nightlies.apache.org/flink/flink-docs-release-1.15/api/python//pyflink.table.html#pyflink.table.Table.limit>) .
...
You can call the “to_pandas” method to [convert a `Table` object to a pandas DataFrame](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/python/table/conversion_of_pandas/#convert-pyflink-table-to-pandas-dataframe>):
...
`TableEnvironment.explain_sql()` and `TableEnvironment.execute_sql()` support executing an `EXPLAIN` statement to get the plans. Please refer to the [EXPLAIN](<//nightlies.apache.org/flink/flink-docs-release-1.15/docs/dev/table/sql/explain/>) page for more details.
