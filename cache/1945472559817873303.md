...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/modules/>).
...
Furthermore, a module can provide built-in [table source and sink factories](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/sourcessinks/#planning>) which disable Flink’s default discovery mechanism based on Java’s Service Provider Interfaces (SPI), or influence how connectors of temporary tables should be created without a corresponding catalog.
...
The `HiveModule` provides Hive built-in functions as Flink’s system functions to SQL and Table API users. Flink’s [Hive documentation](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/connectors/table/hive/hive_functions/>) provides full details on setting up the module.
