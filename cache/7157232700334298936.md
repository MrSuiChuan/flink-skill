...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/python/datastream/intro_to_datastream_api/>).
...
Please see [operators](<//nightlies.apache.org/flink/flink-docs-release-1.20/docs/dev/datastream/operators/overview/>) for an overview of the available DataStream transformations.
