...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/firehose/>).
...
Maven dependency | SQL Client |
    ...
    &ltdependency&gt
          ...
          &ltversion&gt4.2.0-1.17&lt/version&gt
        &lt/dependency&gt

Copied to clipboard!  |  [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-connector-aws-kinesis-firehose/4.2.0-1.17/flink-sql-connector-aws-kinesis-firehose-4.2.0-1.17.jar>)
---|---
