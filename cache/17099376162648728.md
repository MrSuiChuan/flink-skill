...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/release-notes/flink-2.1/>).
...
See more details about the capabilities and usages of Flink’s [Model Inference](<https://nightlies.apache.org/flink/flink-docs-release-2.1/docs/sql/reference/queries/model-inference/>).
