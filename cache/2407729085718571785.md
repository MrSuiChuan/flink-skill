...
There are two kinds of structured types:
  ...
  * Types that are stored in a catalog and are identified by a _catalog identifier_ (like `cat.db.MyType`). Those are equal to the SQL standard definition of structured types.
