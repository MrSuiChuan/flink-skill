...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/sql/reference/utility/explain/>).
...
EXPLAIN statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/interfaces/sql-client/>).
...
Specify `CHANGELOG_MODE` will inform the optimizer to attach the changelog mode (see more details at [Dynamic Tables](<//nightlies.apache.org/flink/flink-docs-master/docs/concepts/sql-table-concepts/dynamic_tables/#table-to-stream-conversion>)) of each physical rel node to the ouptput.
...
Flink SQL provides the plan advice targeting the following issues
  ...
  * Data Skewness caused by Group Aggregation (see more details at [Group Aggregation](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/reference/queries/group-agg/#group-aggregation>) and [Performance Tuning](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/table/tuning/#local-global-aggregation>))
  * Non-deterministic Updates (_abbr._ NDU, see more details at [Determinism In Continuous Queries](<//nightlies.apache.org/flink/flink-docs-master/docs/concepts/sql-table-concepts/determinism/#3-determinism-in-streaming-processing>))
...
For query syntax, please refer to [Queries](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/reference/queries/overview/>) page. For insert syntax, please refer to [INSERT](<//nightlies.apache.org/flink/flink-docs-master/docs/sql/reference/dml/insert/>) page.