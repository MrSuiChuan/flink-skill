...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/ops/events/>).
...
For information on how to set up Flink’s event reporters please take a look at the [event reporters documentation](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/event_reporters/>).
