...
See [DataStream API Integration](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/data_stream_api/>) for details.

##  Where to Go Next #

  * [Table API](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/overview/>): Declarative API for relational operations.
  * [DataStream API](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/overview/>): Imperative API for stream processing.
  * [Configuration](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/configuration/overview/>): Project setup and dependencies.

###  Getting Started Tutorials #

  * [Flink SQL Tutorial](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/quickstart-sql/>): Get started with SQL (no programming required).
  * [Table API Tutorial](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/table_api/>): Build a streaming pipeline with the Table API.
  * [DataStream API Tutorial](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/getting-started/datastream/>): Build an event-driven application with the DataStream API.
