#  [Introducing Complex Event Processing (CEP) with Apache Flink](</2016/04/06/introducing-complex-event-processing-cep-with-apache-flink/>)
...
_Note:_ The example code requires Flink 1.0.1 or higher.

[Want to contribute translation?](<https://cwiki.apache.org/confluence/display/FLINK/Flink+Translation+Specifications>)

[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2016-04-06-cep-monitoring.md>)