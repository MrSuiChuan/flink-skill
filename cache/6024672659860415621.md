...
DataStream API programs can be executed in one of two execution modes: `BATCH` or `STREAMING`. See [Execution Mode](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/datastream/execution_mode/>) for more details.
...
A unique identifier of an Operator at runtime, otherwise known as “Operator ID” or “Vertex ID” and generated from a UID. It is commonly exposed in logs, the REST API or metrics, and most importantly is how operators are identified within [savepoints](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/ops/state/savepoints/>).