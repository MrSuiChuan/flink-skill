...
Steps to run a secure Flink cluster in standalone/cluster mode:
  ...
  1. Add security-related configuration options to the Flink configuration file (on all cluster nodes) (see [here](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/config/#auth-with-external-systems>)).
...
Steps to run a secure Flink cluster in native Kubernetes and YARN mode:
  ...
  1. Add security-related configuration options to the Flink configuration file on the client (see [here](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/config/#auth-with-external-systems>)).
...
In Flink 1.17 delegation token support added as an experimental feature. This is quite a heavyweight topic so there is a general delegation token [information page](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/security/security-delegation-token/>).
