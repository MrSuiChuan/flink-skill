...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/hybridsource/>).

#  Hybrid Source #

`HybridSource` is a source that contains a list of concrete [sources](<//nightlies.apache.org/flink/flink-docs-release-1.18/docs/dev/datastream/sources/>). It solves the problem of sequentially reading input from heterogeneous sources to produce a single input stream.
