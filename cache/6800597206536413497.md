...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/sql/reference/queries/vector-search/>).
...
###  Notes #
  ...
  1. The implementation of the vector table must implement interface `org.apache.flink.table.connector.source.VectorSearchTableSource`. Please refer to [Vector Search Table Source](<//nightlies.apache.org/flink/flink-docs-master/docs/dev/table/sourcessinks/#vector-search-table-source>) for details.
