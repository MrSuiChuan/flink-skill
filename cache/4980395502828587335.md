...
Emitting data to a side output is possible from the following functions:
  ...
  * [ProcessFunction](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/process_function/>)
  * [KeyedProcessFunction](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/process_function/#the-keyedprocessfunction>)
  * CoProcessFunction
  * KeyedCoProcessFunction
  * [ProcessWindowFunction](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/datastream/operators/windows/#processwindowfunction>)
