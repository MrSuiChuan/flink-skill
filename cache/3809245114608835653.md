...
The following example programs showcase different applications of Flink from simple word counting to graph algorithms. The code samples illustrate the use of [Flink’s DataSet API](<//nightlies.apache.org/flink/flink-docs-release-1.13/docs/dev/dataset/overview/>).

The full source code of the following and more examples can be found in the [ flink-examples-batch ](<//github.com/apache/flink/blob/release-1.13/flink-examples/flink-examples-batch>) module of the Flink source repository.
...
The [ WordCount example ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/java/org/apache/flink/examples/java/wordcount/WordCount.java>)

implements the above described algorithm with input parameters: `--input <path> --output <path>`. As test data, any text file will do.
...
The [ WordCount example ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/scala/org/apache/flink/examples/scala/wordcount/WordCount.scala>)
...
The [ PageRank program ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/java/org/apache/flink/examples/java/graph/PageRank.java>)

implements the above example. It requires the following parameters to run: `--pages <path> --links <path> --output <path> --numPages <n> --iterations <n>`.
...
The [ PageRank program ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/scala/org/apache/flink/examples/scala/graph/PageRankBasic.scala>)
...
The [ ConnectedComponents program ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/java/org/apache/flink/examples/java/graph/ConnectedComponents.java>)

implements the above example. It requires the following parameters to run: `--vertices <path> --edges <path> --output <path> --iterations <n>`.
...
The [ ConnectedComponents program ](<//github.com/apache/flink/blob/release-1.13//flink-examples/flink-examples-batch/src/main/scala/org/apache/flink/examples/scala/graph/ConnectedComponents.scala>)
