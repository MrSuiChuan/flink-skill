...
We recommend to set up the IDE to automatically check the code style. Please follow the [ IDE Setup Guide ](<//nightlies.apache.org/flink/flink-docs-stable/docs/flinkdev/ide_setup/>) to set up [ spotless ](<//nightlies.apache.org/flink/flink-docs-stable/docs/flinkdev/ide_setup/#code-formatting>) and [ checkstyle ](<//nightlies.apache.org/flink/flink-docs-stable/docs/flinkdev/ide_setup/#checkstyle-for-java>) .
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/how-to-contribute/code-style-and-quality-formatting.md>)