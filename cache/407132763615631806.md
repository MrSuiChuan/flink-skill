...
Flink ships with two high availability service implementations:
  ...
  * [ZooKeeper](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/ha/zookeeper_ha/>): ZooKeeper HA services can be used with every Flink cluster deployment. They require a running ZooKeeper quorum.

  * [Kubernetes](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/deployment/ha/kubernetes_ha/>): Kubernetes HA services only work when running on Kubernetes.
