...
---|---
FROM_CHANGELOG | Converts an append-only table with operation codes into a (potentially updating) dynamic table
TO_CHANGELOG | Converts a dynamic table into an append-only table with explicit operation codes
