...
The Avro Schema Registry format can only be used in conjunction with the [Apache Kafka SQL connector](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/table/kafka/>) or the [Upsert Kafka SQL Connector](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/connectors/table/upsert-kafka/>).
...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-avro-confluent-registry/2.0.1/flink-sql-avro-confluent-registry-2.0.1.jar>)
---|---
