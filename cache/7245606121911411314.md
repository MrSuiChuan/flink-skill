...
In order to use the Amazon Kinesis Data Firehose connector the following dependencies are required for both projects using a build automation tool (such as Maven or SBT) and SQL Client with SQL JAR bundles.
...
Maven dependency | SQL Client |
    ...
    &ltdependency&gt
      ...
      &ltartifactId&gtflink-connector-kinesis-firehose&lt/artifactId&gt
      &ltversion&gt1.15.4&lt/version&gt
    &lt/dependency&gt

Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-connector-aws-kinesis-firehose/1.15.4/flink-sql-connector-aws-kinesis-firehose-1.15.4.jar>)
---|---
