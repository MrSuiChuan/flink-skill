...
After completing the [installation of flink-agents](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/installation/>) and building your [ReAct Agent](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/react_agent/>) or [Workflow Agent](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/workflow_agent/>), you can test and execute your agent locally using a simple Python script. This allows you to validate logic without requiring a Flink cluster.
...
Follow the [instructions](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/installation/>) to install the Flink Agents Python and Java libraries.
...
See [Action State Store Configuration](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/operations/configuration/#action-state-store>) for configuration options.
