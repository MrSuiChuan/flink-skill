...
This page describes deploying a [standalone](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/resource-providers/standalone/overview/>) Flink cluster on top of Kubernetes, using Flink’s standalone deployment. We generally recommend new users to deploy Flink on Kubernetes using [native Kubernetes deployments](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/resource-providers/native_kubernetes/>).
...
A _Flink Session cluster_ deployment in Kubernetes has at least three components:
  ...
  * a _Deployment_ which runs a [JobManager](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/concepts/glossary/#flink-jobmanager>)
  * a _Deployment_ for a pool of [TaskManagers](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/concepts/glossary/#flink-taskmanager>)
...
> For high-level intuition behind the application mode, please refer to the [deployment mode overview](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/overview/#application-mode>).
...
> For high-level intuition behind the per-job mode, please refer to the [deployment mode overview](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/overview/#per-job-mode>).

Flink on Standalone Kubernetes does not support the Per-Job Cluster Mode.

###  Session Mode #

> For high-level intuition behind the session mode, please refer to the [deployment mode overview](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/overview/#session-mode>).
...
All configuration options are listed on the [configuration page](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/config/>). Configuration options can be added to the `flink-conf.yaml` section of the `flink-configuration-configmap.yaml` config map.
...
For high availability on Kubernetes, you can use the [existing high availability services](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/ha/overview/>).

####  Kubernetes High-Availability Services #

Session Mode and Application Mode clusters support using the [Kubernetes high availability service](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/ha/kubernetes_ha/>). You need to add the following Flink config options to flink-configuration-configmap.yaml.

Note The filesystem which corresponds to the scheme of your configured HA storage directory must be available to the runtime. Refer to [custom Flink image](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/resource-providers/standalone/docker/#advanced-customization>) and [enable plugins](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/deployment/resource-providers/standalone/docker/#using-filesystem-plugins>) for more information.
