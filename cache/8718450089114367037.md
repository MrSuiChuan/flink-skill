...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/use/>).
...
USE statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.18/docs/dev/table/sqlclient/>).
