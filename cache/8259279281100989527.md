...
A statement for query. See more details in [queries](<//nightlies.apache.org/flink/flink-docs-release-1.16/docs/dev/table/hive-compatibility/hive-dialect/queries/overview/>).
