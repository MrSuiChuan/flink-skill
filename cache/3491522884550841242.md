...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/show/>).
...
SHOW statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sqlclient/>).
...
Show all added jars in the session classloader which are added by [`ADD JAR`](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql/jar/#add-jar>) statements.

Attention Currently `SHOW JARS` statements only work in the [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sqlclient/>) or [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql-gateway/overview/>).
...
Attention Currently `SHOW JOBS` statements only work in the [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sqlclient/>) or [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.0/docs/dev/table/sql-gateway/overview/>).
