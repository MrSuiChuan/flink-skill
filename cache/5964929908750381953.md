...
See the documentation for more details on Flink’s join features [[3]](<//nightlies.apache.org/flink/flink-docs-release-0.8/dataset_transformations.html#join>).
...
After the data has been distributed across all parallel join instances using either a Repartition-Repartition or Broadcast-Forward ship strategy, each instance runs a local join algorithm to join the elements of its local partition. Flink’s runtime features two common join strategies to perform these local joins:
  ...
  * the _Sort-Merge-Join_ strategy (SM) and
  * the _Hybrid-Hash-Join_ strategy (HH).
...
[2] [Flink 0.8.1 documentation: Data Transformations](<//nightlies.apache.org/flink/flink-docs-release-0.8/dataset_transformations.html>)
[3] [Flink 0.8.1 documentation: Joins](<//nightlies.apache.org/flink/flink-docs-release-0.8/dataset_transformations.html#join>)
[4] [Flink 1.0 documentation: Semantic annotations](<//nightlies.apache.org/flink/flink-docs-release-1.0/apis/batch/index.html#semantic-annotations>)
[5] [Flink 1.0 documentation: Optimizer join hints](<//nightlies.apache.org/flink/flink-docs-release-1.0/apis/batch/dataset_transformations.html#join-algorithm-hints>)

[Want to contribute translation?](<https://cwiki.apache.org/confluence/display/FLINK/Flink+Translation+Specifications>)

[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2015-03-13-peeking-into-Apache-Flinks-Engine-Room.md>)