...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/formats/csv/>).
...
Similarly to the `TextLineInputFormat`, `CsvReaderFormat` can be used in both continues and batch modes (see [TextLineInputFormat](<//nightlies.apache.org/flink/flink-docs-master/docs/connectors/datastream/formats/text_files/>) for examples).
