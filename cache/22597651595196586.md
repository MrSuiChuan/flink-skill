...
SHOW statements can be executed in [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/sqlclient/>).
...
Show all added jars in the session classloader which are added by [`ADD JAR`](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/sql/jar/#add-jar>) statements.

Attention Currently `SHOW JARS` only works in the [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/sqlclient/>).
