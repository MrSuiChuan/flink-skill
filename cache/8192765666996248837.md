...
A few things to notice in the YAML above:
  ...
  * `clazz: ollama` is an alias resolved by the loader to the full Ollama chat-model class — see the alias table in the [YAML API](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/yaml/#class-aliases>) doc.
...
> See [Integrate with Flink](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/development/integrate_with_flink/>) for details on integrating agents with the Flink DataStream and Table API.
...
Follow the [installation](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/installation/>) instructions to set up Flink and Flink Agents.
...
Java
  ...
  1. Build Flink Agents from source to generate example jar. See [installation](<//nightlies.apache.org/flink/flink-agents-docs-release-0.3/docs/get-started/installation/>) for more details.
