...
> PTFs follow similar implementation principles as other user-defined functions in Flink. Please see [implementation guide for user-defined functions](<//nightlies.apache.org/flink/flink-docs-release-2.3/docs/dev/table/functions/udfs/#implementation-guide>) for more details. This page focuses on PTF specifics.
