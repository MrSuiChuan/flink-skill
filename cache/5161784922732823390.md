...
Flink SQL provides the `ML_PREDICT` table-valued function (TVF) to perform model inference in SQL queries. This function allows you to apply machine learning models to your data streams directly in SQL. See [Model Creation](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/table/sql/create/#create-model>) about how to create a model.
...
###  Related Statements #
  ...
  * [Model Creation](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/table/sql/create/#create-model>)
  * [Model Alteration](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/table/sql/alter/#alter-model>)
