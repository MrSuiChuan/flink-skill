...
Copied to clipboard!  | [Download](<https://repo.maven.apache.org/maven2/org/apache/flink/flink-sql-protobuf/1.19.3/flink-sql-protobuf-1.19.3.jar>)
---|---
...
Below is the proto definition file.
  ...
  3. Finally you should provide the `jar` in your classpath, e.g. pass it using `-j` in [sql-client](<//nightlies.apache.org/flink/flink-docs-release-1.19/docs/dev/table/sqlclient/>)
