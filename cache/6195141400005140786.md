...
The log files can be accessed via the Job-/TaskManager pages of the WebUI. The used [Resource Provider](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/overview/>) (e.g., YARN) may provide additional means of accessing them.
...
The following [logging-related configuration options](<//nightlies.apache.org/flink/flink-docs-release-2.2/docs/deployment/config/#jvm-and-logging-options>) are available:
