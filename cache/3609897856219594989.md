...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/docs/sql/materialized-table/quickstart/>).
...
The method here is similar to the steps recorded in [local installation](<//nightlies.apache.org/flink/flink-docs-master/docs/getting-started/local_installation/>). Flink can run on any UNIX-like operating system, such as Linux, Mac OS X, and Cygwin (for Windows).
