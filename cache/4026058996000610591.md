...
> This documentation is for an unreleased version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/connectors/table/mongodb/>).
...
MongoDB 连接器目前并不包含在 Flink 的二进制发行版中，请查阅[这里](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/configuration/overview/>)了解如何在集群运行中引用 MongoDB 连接器。
...
有关 PRIMARY KEY 语法的更多详细信息，请参见 [CREATE TABLE DDL](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/table/sql/create/#create-table>)。
...
[MongoDB BSON type](<https://www.mongodb.com/docs/manual/reference/bson-types/#bson-types>) | [Flink SQL type](<//nightlies.apache.org/flink/flink-docs-master/zh/docs/dev/table/types/>)
---|---
`ObjectId` | `STRING`
`String` | `STRING`
`Boolean` | `BOOLEAN`
