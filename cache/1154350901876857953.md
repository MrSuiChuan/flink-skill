...
If you’re interested in playing around with Flink ML, check out our [quick start](<//nightlies.apache.org/flink/flink-ml-docs-release-2.2/docs/try-flink-ml/java/quick-start/>). It provides a simple example to submit and execute a Flink ML job on a Flink cluster.
