...
DESCRIBE 语句可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 中执行。
...
Attention DESCRIBE JOB 语句仅适用于 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-client/>) 或者 [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-2.3/zh/docs/sql/interfaces/sql-gateway/overview/>).
