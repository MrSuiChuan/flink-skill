...
`HybridSource` is a source that contains a list of concrete [sources](<//nightlies.apache.org/flink/flink-docs-release-2.1/docs/dev/datastream/sources/>). It solves the problem of sequentially reading input from heterogeneous sources to produce a single input stream.
