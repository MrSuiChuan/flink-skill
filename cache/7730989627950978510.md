...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/dev/table/sql/show/>).
...
可以在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sqlclient/>) 中执行 SHOW 语句。
...
展示所有通过 [`ADD JAR`](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sql/jar/#add-jar>) 语句加入到 session classloader 中的 jar。

Attention 当前 SHOW JARS 命令只能在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sqlclient/>) 或者 [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sql-gateway/overview/>) 中使用.
...
Attention 当前 SHOW JOBS 命令只能在 [SQL CLI](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sqlclient/>) 或者 [SQL Gateway](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/sql-gateway/overview/>) 中使用.
