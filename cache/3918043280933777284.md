...
Like most data systems, Apache Flink supports aggregate functions; both built-in and user-defined. [User-defined functions](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/functions/udfs/>) must be registered in a catalog before use.
...
Apache Flink provides a set of performance tuning ways for Group Aggregation, see more [Performance Tuning](<//nightlies.apache.org/flink/flink-docs-release-1.14/docs/dev/table/tuning/>).
