#  [Apache Flink Kubernetes Operator 1.4.0 Release Announcement](</2023/02/27/apache-flink-kubernetes-operator-1.4.0-release-announcement/>)

February 27, 2023 - Gyula Fora [(@GyulaFora)](<https://twitter.com/GyulaFora>) Maximilian Michels [(@stadtlegende)](<https://twitter.com/stadtlegende>) Matyas Orhidi [(@matyasorhidi)](<https://twitter.com/matyasorhidi>)
...
The approach is based on [Three steps is all you need: fast, accurate, automatic scaling decisions for distributed streaming dataflows](<https://www.usenix.org/system/files/osdi18-kalavri.pdf>) by Kalavri et al. Shoutout to our fellow Flink community member and committer Vasiliki Kalavri! The used metrics include: Source metrics:
...
[ Edit This Page __](<//github.com/apache/flink-web/edit/asf-site/docs/content/posts/2023-02-27-release-kubernetes-operator-1.4.0.md>)