...
Flink currently has the following **built-in accumulators**. Each of them implements the [ Accumulator ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/Accumulator.java>) interface.

  * [ **IntCounter** ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/IntCounter.java>) , [ **LongCounter** ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/LongCounter.java>) and [ **DoubleCounter** ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/DoubleCounter.java>) : See below for an example using a counter.
  * [ **Histogram** ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/Histogram.java>) : A histogram implementation for a discrete number of bins. Internally it is just a map from Integer to Integer. You can use this to compute distributions of values, e.g. the distribution of words-per-line for a word count program.
...
You have the choice to implement either [ Accumulator ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/Accumulator.java>) or [ SimpleAccumulator ](<//github.com/apache/flink/blob/release-1.20//flink-core/src/main/java/org/apache/flink/api/common/accumulators/SimpleAccumulator.java>) .
