...
> This documentation is for an out-of-date version of Apache Flink. We recommend you use the latest [stable version](<//nightlies.apache.org/flink/flink-docs-stable/zh/docs/connectors/table/hive/overview/>).
...
通过 TableEnvironment 或者 YAML 配置，使用 [Catalog 接口](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/catalogs/>) 和 [HiveCatalog](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/connectors/table/hive/hive_catalog/>)连接到现有的 Hive 集群。
...
| 否 | (无) | String | HiveCatalog 能够自动检测使用的 Hive 版本。我们建议**不要** 手动设置 Hive 版本，除非自动检测机制失败。
...
在 Flink 中执行 DDL 操作 Hive 的表、视图、分区、函数等元数据时，建议使用 [Hive 方言](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/dev/table/hive-compatibility/hive-dialect/overview/>)

##  DML #

Flink 支持 DML 写入 Hive 表，请参考[读写 Hive 表](<//nightlies.apache.org/flink/flink-docs-release-1.20/zh/docs/connectors/table/hive/hive_read_write/>)